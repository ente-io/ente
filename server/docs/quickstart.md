...
After the Docker compose cluster starts, you can open Ente web app at http://localhost:3000. Public album links are served from http://localhost:3002.

> [!TIP]
>
> The verification code when you try to create an account can be seen in the logs (See [self hosting docs](https://ente.com/help/self-hosting/faq/otp#verification-code) for more ways to get it)
...
Finally, it starts the Docker compose cluster running the following services on 4 open ports:
