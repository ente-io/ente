...
const (
	...
	RecoveryCompletedTemplate    string = "legacy/recovery_completed.html"
...
func (c *Controller) sendRecoveryNotification(ctx context.Context, legacyUserID int64, trustedUserID int64, newStatus ente.RecoveryStatus) error {
	...
	if newStatus == ente.RecoveryStatusInitiated {
	...
	} else if newStatus == ente.RecoveryStatusRecovered {
		emailTo = legacyUser.Email
	...
	if newStatus == ente.RecoveryStatusReady {
		emailTo = legacyUser.Email
