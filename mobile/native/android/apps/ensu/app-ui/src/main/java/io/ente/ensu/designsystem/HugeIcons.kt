...
object HugeIcons {
    val ArrowDown01Icon = R.drawable.hugeicon_arrow_down01
    val ArrowLeft01Icon = R.drawable.hugeicon_arrow_left01
    val ArrowRight01Icon = R.drawable.hugeicon_arrow_right01
    val ArrowRight02Icon = R.drawable.hugeicon_arrow_right02
    val ArrowReloadHorizontalIcon = R.drawable.hugeicon_arrow_reload_horizontal
    val Attachment01Icon = R.drawable.hugeicon_attachment01
    ...
    val RefreshIcon = R.drawable.hugeicon_refresh
    ...
    val SlidersHorizontalIcon = R.drawable.hugeicon_sliders_horizontal
    val StopCircleIcon = R.drawable.hugeicon_stop_circle
