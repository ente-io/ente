...
final LRUMap<String, Uint8List?> _faceCropCache = LRUMap(200);
final LRUMap<String, Uint8List?> _faceCropThumbnailCache = LRUMap(200);

final LRUMap<String, String> _personOrClusterIdToCachedFaceID = LRUMap(200);
