...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m41(endDate) => "ניסיון חינם בתוקף עד ל-${endDate}";

  static String m47(count) =>
      "${Intl.plural(count, one: '${count} פריט', two: '${count} פריטים', many: '${count} פריטים', other: '${count} פריטים')}";

  static String m50(expiryTime) => "תוקף הקישור יפוג ב-${expiryTime}";
  ...
  static String m95(email) => "זה מזהה האימות של ${email}";

  static String m106(email) => "אמת ${email}";
  ...
  static String m110(storageSaved) => "הצלחת לפנות ${storageSaved}!";
