...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m16(emailOrName) => "Dodane przez ${emailOrName}";

  static String m17(albumName) => "Pomyślnie dodano do  ${albumName}";

  static String m18(count) =>
      "${Intl.plural(count, zero: 'Brak Uczestników', one: '1 Uczestnik', other: '${count} Uczestników')}";

  static String m19(versionValue) => "Wersja: ${versionValue}";
  ...
  static String m24(albumName) => "Utworzono link współpracy dla ${albumName}";
  ...
  static String m48(albumName) => "Pomyślnie przeniesiono do ${albumName}";

  static String m0(personName) => "No suggestions for ${personName}";

  static String m49(name) => "Nie ${name}?";
  ...
  static String m59(endDate) => "Subskrypcja odnowi się ${endDate}";
  ...
  static String m10(count) => "Wybrano ${count}";
  ...
  static String m65(emailIDs) => "Udostępnione z ${emailIDs}";
  ...
  static String m68(fileType) => "Ten ${fileType} zostanie usunięty z Ente.";
  ...
  static String m74(email) => "To jest identyfikator weryfikacyjny ${email}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "extraPhotosFoundFor": MessageLookupByLibrary.simpleMessage(
            "Znaleziono dodatkowe zdjęcia dla \$text"),
