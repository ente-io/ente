...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m43(toEmail) => "Prosimy wysłać logi do ${toEmail}";

  static String m44(storeName) => "Oceń nas na ${storeName}";
