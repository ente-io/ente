...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m56(endpoint) => "已连接至 ${endpoint}";
  ...
  static String m58(newEmail) => "电子邮件已更改为 ${newEmail}";

  static String m59(email) => "${email} 没有 Ente 账户。";

  static String m12(email) => "${email} 没有 Ente 帐户。\n\n向他们发出共享照片的邀请。";

  static String m60(name) => "拥抱 ${name}";

  static String m61(text) => "为 ${text} 找到额外照片";

  static String m62(name) => "与 ${name} 的盛宴";
  ...
  static String m66(sizeInMBorGB) => "释放 ${sizeInMBorGB}";

  static String m67(count, formattedSize) =>
  ...
  static String m69(name) => "与 ${name} 徒步";

  static String m15(count) =>
      "${Intl.plural(count, one: '${count} 个项目', other: '${count} 个项目')}";

  static String m70(name) => "最后一次与 ${name} 相聚";

  static String m71(email) => "${email} 已邀请您成为可信联系人";

  static String m16(expiryTime) => "链接将在 ${expiryTime} 过期";

  static String m72(email) => "将人员链接到 ${email}";

  static String m73(personName, email) => "这将会将 ${personName} 链接到 ${email}";

  static String m74(count, formattedCount) =>
      "${Intl.plural(count, zero: '暂无回忆', other: '${formattedCount} 个回忆')}";

  static String m75(count) =>
      "${Intl.plural(count, one: '移动项目', other: '移动数个项目')}";

  static String m76(albumName) => "成功移动到 ${albumName}";

  static String m77(personName) => "没有针对 ${personName} 的建议";

  static String m78(name) => "不是 ${name}？";

  static String m17(familyAdminEmail) => "请联系${familyAdminEmail} 以更改您的代码。";

  static String m79(name) => "与 ${name} 开派对";
  ...
  static String m80(name, age) => "${name}  ${age} 岁啦！";

  static String m81(name, age) => "${name} 快满 ${age} 岁啦";
  ...
  static String m83(toEmail) => "请给我们发送电子邮件至 ${toEmail}";

  static String m84(toEmail) => "请将日志发送至 \n${toEmail}";

  static String m85(name) => "与 ${name} 的合影";

  static String m86(folderName) => "正在处理 ${folderName}...";

  static String m21(storeName) => "在 ${storeName} 上给我们评分";

  static String m87(name) => "已将您重新分配给 ${name}";

  static String m88(days, email) => "您可以在 ${days} 天后访问该账户。通知将发送至 ${email}。";

  static String m89(email) => "您现在可以通过设置新密码来恢复 ${email} 的账户。";

  static String m90(email) => "${email} 正在尝试恢复您的账户。";
  ...
  static String m91(name) => "与 ${name} 一起的自驾游";
  ...
  static String m94(name) => "与 ${name} 的自拍";
  ...
  static String m95(emailIDs) => "与 ${emailIDs} 共享";
  ...
  static String m96(name) => "与 ${name} 一起运动";

  static String m97(name) => "聚光灯下的 ${name}";
  ...
  static String m99(completed, total) => "已保存的回忆 ${completed}/共 ${total}";

  static String m100(ignoreReason) => "点按上传，由于${ignoreReason}，目前上传已被忽略";
  ...
  static String m111(name) => "您和 ${name}";
