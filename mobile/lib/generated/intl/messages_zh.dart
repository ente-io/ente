...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m17(versionValue) => "版本: ${versionValue}";

  static String m18(freeAmount, storageUnit) =>
      "${freeAmount} ${storageUnit} 空闲";

  static String m19(paymentProvider) => "请先取消您现有的订阅 ${paymentProvider}";
  ...
  static String m21(albumName) => "为 ${albumName} 创建了协作链接";
  ...
  static String m36(text) => "为 ${text} 找到额外照片";
  ...
  static String m54(providerName) => "如果您被收取费用，请用英语与 ${providerName} 的客服聊天";

  static String m55(count) =>
      "${Intl.plural(count, zero: '0 张照片', one: '1 张照片', other: '${count} 张照片')}";

  static String m56(endDate) => "免费试用有效期至 ${endDate}。\n在此之后您可以选择付费计划。";
  ...
  static String m60(storeName) => "在 ${storeName} 上给我们评分";

  static String m61(name) => "已将您重新分配给 ${name}";

  static String m62(days, email) => "您可以在 ${days} 天后访问该账户。通知将发送至 ${email}。";

  static String m63(email) => "您现在可以通过设置新密码来恢复 ${email} 的账户。";

  static String m64(email) => "${email} 正在尝试恢复您的账户。";

  static String m65(storageInGB) => "3. 你和朋友都将免费获得 ${storageInGB} GB*";

  static String m66(userEmail) =>
      "${userEmail} 将从这个共享相册中删除\n\nTA们添加的任何照片也将从相册中删除";

  static String m67(endDate) => "在 ${endDate} 前续费";
  ...
  static String m70(count, yourCount) => "选择了 ${count} 个 (您的 ${yourCount} 个)";

  static String m71(verificationID) => "这是我的ente.io 的验证 ID： ${verificationID}。";
  ...
  static String m74(emailIDs) => "与 ${emailIDs} 共享";

  static String m75(fileType) => "此 ${fileType} 将从您的设备中删除。";

  static String m76(fileType) => "${fileType} 已同时存在于 Ente 和您的设备中。";

  static String m77(fileType) => "${fileType} 将从 Ente 中删除。";
  ...
  static String m80(endDate) => "您的订阅将于 ${endDate} 取消";

  static String m81(completed, total) => "已保存的回忆 ${completed}/共 ${total}";

  static String m82(ignoreReason) => "点按上传，由于${ignoreReason}，目前上传已被忽略";

  static String m8(storageAmountInGB) => "他们也会获得 ${storageAmountInGB} GB";

  static String m83(email) => "这是 ${email} 的验证ID";

  static String m84(count) =>
      "${Intl.plural(count, zero: '马上', one: '1 天', other: '${count} 天')}";

  static String m85(email) => "您已受邀通过 ${email} 成为遗产联系人。";

  static String m86(galleryType) => "相册类型 ${galleryType} 不支持重命名";

  static String m87(ignoreReason) => "由于 ${ignoreReason}，上传被忽略";

  static String m88(count) => "正在保存 ${count} 个回忆...";

  static String m89(endDate) => "有效期至 ${endDate}";

  static String m90(email) => "验证 ${email}";
  ...
  static String m93(storageSaved) => "您已成功释放了 ${storageSaved}！";
