...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m111(name) => "与 ${name} 一起欣赏美景";
  ...
  static String m29(albumName) => "这将删除用于访问\"${albumName}\"的公开链接。";

  static String m30(supportEmail) => "请从您注册的邮箱发送一封邮件到 ${supportEmail}";
  ...
  static String m33(newEmail) => "电子邮件已更改为 ${newEmail}";

  static String m34(email) => "${email} 没有 Ente 账户。";

  static String m35(email) => "${email} 没有 Ente 帐户。\n\n向他们发出共享照片的邀请。";

  static String m36(name) => "拥抱 ${name}";

  static String m37(text) => "为 ${text} 找到额外照片";

  static String m38(name) => "与 ${name} 的盛宴";
  ...
  static String m43(sizeInMBorGB) => "释放 ${sizeInMBorGB}";

  static String m44(count, formattedSize) =>
      "${Intl.plural(count, one: '它可以从设备中删除以释放 ${formattedSize}', other: '它们可以从设备中删除以释放 ${formattedSize}')}";

  static String m45(currentlyProcessing, totalCount) =>
      "正在处理 ${currentlyProcessing} / ${totalCount}";

  static String m46(name) => "与 ${name} 徒步";

  static String m47(count) =>
      "${Intl.plural(count, one: '${count} 个项目', other: '${count} 个项目')}";

  static String m48(name) => "最后一次与 ${name} 相聚";

  static String m49(email) => "${email} 已邀请您成为可信联系人";

  static String m50(expiryTime) => "链接将在 ${expiryTime} 过期";

  static String m51(email) => "将人员链接到 ${email}";

  static String m52(personName, email) => "这将会将 ${personName} 链接到 ${email}";
  ...
  static String m55(personName) => "没有针对 ${personName} 的建议";

  static String m56(name) => "不是 ${name}？";

  static String m57(familyAdminEmail) => "请联系${familyAdminEmail} 以更改您的代码。";

  static String m58(name) => "与 ${name} 开派对";
  ...
  static String m79(count, yourCount) => "选择了 ${count} 个 (您的 ${yourCount} 个)";

  static String m80(name) => "与 ${name} 的自拍";

  static String m81(verificationID) => "这是我的ente.io 的验证 ID： ${verificationID}。";
  ...
  static String m84(emailIDs) => "与 ${emailIDs} 共享";

  static String m85(fileType) => "此 ${fileType} 将从您的设备中删除。";

  static String m86(fileType) => "${fileType} 已同时存在于 Ente 和您的设备中。";

  static String m87(fileType) => "${fileType} 将从 Ente 中删除。";

  static String m88(name) => "与 ${name} 一起运动";

  static String m89(name) => "聚光灯下的 ${name}";
  ...
  static String m92(endDate) => "您的订阅将于 ${endDate} 取消";

  static String m93(completed, total) => "已保存的回忆 ${completed}/共 ${total}";

  static String m94(ignoreReason) => "点按上传，由于${ignoreReason}，目前上传已被忽略";

  static String m8(storageAmountInGB) => "他们也会获得 ${storageAmountInGB} GB";

  static String m95(email) => "这是 ${email} 的验证ID";

  static String m96(count) =>
      "${Intl.plural(count, one: '${count} 年前的本周', other: '${count} 年前的本周')}";

  static String m97(dateFormat) => "${dateFormat} 年间";

  static String m98(count) =>
      "${Intl.plural(count, zero: '马上', one: '1 天', other: '${count} 天')}";

  static String m99(year) => "${year} 年的旅行";

  static String m100(location) => "前往 ${location} 的旅行";

  static String m101(email) => "您已受邀通过 ${email} 成为遗产联系人。";

  static String m102(galleryType) => "相册类型 ${galleryType} 不支持重命名";

  static String m103(ignoreReason) => "由于 ${ignoreReason}，上传被忽略";

  static String m104(count) => "正在保存 ${count} 个回忆...";

  static String m105(endDate) => "有效期至 ${endDate}";

  static String m106(email) => "验证 ${email}";
  ...
  static String m109(name) => "您和 ${name}";

  static String m110(storageSaved) => "您已成功释放了 ${storageSaved}！";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "filesBackedUpFromDevice": m39,
        "filesBackedUpInAlbum": m40,
        ...
        "freeTrialValidTill": m41,
        "freeUpAccessPostDelete": m42,
        "freeUpAmount": m43,
        ...
        "linkPersonToEmail": m51,
        "linkPersonToEmailConfirmation": m52,
        ...
        "onlyFamilyAdminCanChangeCode": m57,
        ...
        "typeOfGallerGallerytypeIsNotSupportedForRename": m102,
        ...
        "uploadIsIgnoredDueToIgnorereason": m103,
        "uploadingFilesToAlbum":
            MessageLookupByLibrary.simpleMessage("正在将文件上传到相册..."),
        "uploadingMultipleMemories": m104,
        ...
        "youHaveSuccessfullyFreedUp": m110,
