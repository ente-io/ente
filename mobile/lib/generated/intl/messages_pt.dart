...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m9(title) => "${title} (Eu)";
  ...
  static String m14(emailOrName) => "Adicionado por ${emailOrName}";

  static String m15(albumName) => "Adicionado com sucesso a  ${albumName}";

  static String m16(name) => "Admirando ${name}";

  static String m17(count) =>
      "${Intl.plural(count, zero: 'Nenhum participante', one: '1 participante', other: '${count} participantes')}";

  static String m18(versionValue) => "Versão: ${versionValue}";

  static String m19(freeAmount, storageUnit) =>
      "${freeAmount} ${storageUnit} livre";

  static String m111(name) => "Vistas bonitas com ${name}";
  ...
  static String m22(albumName) => "Link colaborativo criado para ${albumName}";
  ...
  static String m26(endpoint) => "Conectado à ${endpoint}";
  ...
  static String m33(newEmail) => "E-mail alterado para ${newEmail}";

  static String m34(email) => "${email} não possui uma conta Ente.";

  static String m35(email) =>
      "${email} não tem uma conta Ente.\n\nEnvie-os um convite para compartilhar fotos.";

  static String m36(name) => "Abraçando ${name}";

  static String m37(text) => "Fotos adicionais encontradas para ${text}";

  static String m38(name) => "Tendo banquete com ${name}";
  ...
  static String m46(name) => "Caminhando com ${name}";

  static String m47(count) =>
      "${Intl.plural(count, one: '${count} item', other: '${count} itens')}";

  static String m48(name) => "Últimos momentos com ${name}";

  static String m49(email) =>
      "${email} convidou você para ser um contato confiável";

  static String m50(expiryTime) => "O link expirará em ${expiryTime}";

  static String m51(email) => "Vincular pessoa a ${email}";
  ...
  static String m54(albumName) => "Movido com sucesso para ${albumName}";

  static String m55(personName) => "Sem sugestões para ${personName}";

  static String m56(name) => "Não é ${name}?";

  static String m57(familyAdminEmail) =>
      "Entre em contato com ${familyAdminEmail} para alterar o seu código.";

  static String m58(name) => "Festejando com ${name}";
  ...
  static String m80(name) => "Tirando selfies com ${name}";
  ...
  static String m84(emailIDs) => "Compartilhado com ${emailIDs}";
  ...
  static String m87(fileType) => "Este ${fileType} será excluído do Ente.";

  static String m88(name) => "Jogando esportes com ${name}";

  static String m89(name) => "Destacar ${name}";
  ...
  static String m92(endDate) => "Sua assinatura será cancelada em ${endDate}";
  ...
  static String m95(email) => "Este é o ID de verificação de ${email}";

  static String m96(count) =>
      "${Intl.plural(count, one: 'Esta semana, ${count} ano atrás', other: 'Esta semana, ${count} anos atrás')}";

  static String m97(dateFormat) => "${dateFormat} com o passar dos anos";

  static String m98(count) =>
      "${Intl.plural(count, zero: 'Em breve', one: '1 dia', other: '${count} dias')}";

  static String m99(year) => "Viajem em ${year}";

  static String m100(location) => "Viajem à ${location}";
  ...
  static String m104(count) => "Preservando ${count} memórias...";

  static String m105(endDate) => "Válido até ${endDate}";

  static String m106(email) => "Verificar ${email}";
  ...
  static String m2(email) => "Enviamos um e-mail à <green>${email}</green>";

  static String m108(count) =>
      "${Intl.plural(count, one: '${count} ano atrás', other: '${count} anos atrás')}";

  static String m109(name) => "Você e ${name}";

  static String m110(storageSaved) =>
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "deleteEmailRequest": MessageLookupByLibrary.simpleMessage(
            "Por favor, envie um e-mail a <warning>account-deletion@ente.io</warning> do seu endereço de e-mail registrado."),
        "deleteEmptyAlbums":
