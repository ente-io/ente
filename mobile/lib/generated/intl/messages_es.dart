...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m9(title) => "${title} (Yo)";
  ...
  static String m14(emailOrName) => "Añadido por ${emailOrName}";

  static String m15(albumName) => "Añadido exitosamente a  ${albumName}";

  static String m17(count) =>
      "${Intl.plural(count, zero: 'No hay Participantes', one: '1 Participante', other: '${count} Participantes')}";

  static String m18(versionValue) => "Versión: ${versionValue}";
  ...
  static String m26(endpoint) => "Conectado a ${endpoint}";
  ...
  static String m33(newEmail) => "Correo cambiado a ${newEmail}";

  static String m34(email) => "${email} no tiene una cuenta de Ente.";

  static String m35(email) =>
      "${email} no tiene una cuente en Ente.\n\nEnvíale una invitación para compartir fotos.";

  static String m37(text) => "Fotos adicionales encontradas para ${text}";
  ...
  static String m41(endDate) => "Prueba gratuita válida hasta ${endDate}";
  ...
  static String m50(expiryTime) => "El enlace caducará en ${expiryTime}";

  static String m51(email) => "Enlazar persona a ${email}";
  ...
  static String m54(albumName) => "Movido exitosamente a ${albumName}";

  static String m55(personName) => "No hay sugerencias para ${personName}";

  static String m56(name) => "¿No es ${name}?";
  ...
  static String m84(emailIDs) => "Compartido con ${emailIDs}";
  ...
  static String m87(fileType) => "Este ${fileType} será eliminado de Ente.";
  ...
  static String m92(endDate) => "Tu suscripción se cancelará el ${endDate}";
  ...
  static String m95(email) => "Este es el ID de verificación de ${email}";
  ...
  static String m104(count) => "Preservando ${count} memorias...";

  static String m105(endDate) => "Válido hasta ${endDate}";
