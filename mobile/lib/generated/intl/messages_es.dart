...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m56(endpoint) => "Conectado a ${endpoint}";
  ...
  static String m58(newEmail) => "Correo cambiado a ${newEmail}";

  static String m59(email) => "${email} no tiene una cuenta de Ente.";

  static String m12(email) =>
      "${email} no tiene una cuente en Ente.\n\nEnvíale una invitación para compartir fotos.";

  static String m60(name) => "Abrazando a ${name}";

  static String m61(text) => "Fotos adicionales encontradas para ${text}";

  static String m62(name) => "Festejando con ${name}";
  ...
  static String m72(email) => "Enlazar persona a ${email}";

  static String m73(personName, email) =>
      "Esto enlazará a ${personName} a ${email}";

  static String m76(albumName) => "Movido exitosamente a ${albumName}";

  static String m77(personName) => "No hay sugerencias para ${personName}";

  static String m78(name) => "¿No es ${name}?";

  static String m17(familyAdminEmail) =>
      "Por favor, contacta a ${familyAdminEmail} para cambiar tu código.";

  static String m79(name) => "Fiesta con ${name}";
  ...
  static String m81(name, age) => "${name} cumpliendo ${age} pronto";
  ...
  static String m84(toEmail) => "Por favor, envía los registros a ${toEmail}";

  static String m85(name) => "Posando con ${name}";

  static String m86(folderName) => "Procesando ${folderName}...";

  static String m21(storeName) => "Puntúanos en ${storeName}";

  static String m87(name) => "Te has reasignado a ${name}";
  ...
  static String m90(email) => "${email} está intentando recuperar tu cuenta.";
  ...
  static String m91(name) => "Viaje en carretera con ${name}";
  ...
  static String m94(name) => "Selfies con ${name}";
  ...
  static String m95(emailIDs) => "Compartido con ${emailIDs}";
  ...
  static String m96(name) => "Deportes con ${name}";
  ...
  static String m111(name) => "Tú y ${name}";
