...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m18(versionValue) => "Versione: ${versionValue}";
  ...
  static String m22(albumName) => "Link collaborativo creato per ${albumName}";
  ...
  static String m37(text) => "Trovate foto aggiuntive per ${text}";
  ...
  static String m41(endDate) => "La prova gratuita termina il ${endDate}";

  static String m42(count) =>
      "Puoi ancora accedere a ${Intl.plural(count, one: '', other: 'loro')} su ente finché hai un abbonamento attivo";

  static String m43(sizeInMBorGB) => "Libera ${sizeInMBorGB}";
  ...
  static String m50(expiryTime) => "Il link scadrà il ${expiryTime}";

  static String m51(email) => "Collega persona a ${email}";
  ...
  static String m54(albumName) => "Spostato con successo su ${albumName}";

  static String m55(personName) => "Nessun suggerimento per ${personName}";

  static String m56(name) => "Non è ${name}?";
  ...
  static String m84(emailIDs) => "Condiviso con ${emailIDs}";
  ...
  static String m87(fileType) => "Questo ${fileType} verrà eliminato da Ente.";
  ...
  static String m95(email) => "Questo è l\'ID di verifica di ${email}";
  ...
  static String m104(count) => "Conservando ${count} ricordi...";

  static String m105(endDate) => "Valido fino al ${endDate}";

  static String m106(email) => "Verifica ${email}";
