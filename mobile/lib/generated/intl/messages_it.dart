...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m16(emailOrName) => "Aggiunto da ${emailOrName}";

  static String m17(albumName) => "Aggiunto con successo su ${albumName}";

  static String m18(count) =>
      "${Intl.plural(count, zero: 'Nessun partecipante', one: '1 Partecipante', other: '${count} Partecipanti')}";

  static String m19(versionValue) => "Versione: ${versionValue}";
  ...
  static String m24(albumName) => "Link collaborativo creato per ${albumName}";
  ...
  static String m48(albumName) => "Spostato con successo su ${albumName}";

  static String m0(personName) => "No suggestions for ${personName}";

  static String m49(name) => "Non è ${name}?";
  ...
  static String m59(endDate) => "Si rinnova il ${endDate}";
  ...
  static String m10(count) => "${count} selezionati";
  ...
  static String m65(emailIDs) => "Condiviso con ${emailIDs}";
  ...
  static String m68(fileType) => "Questo ${fileType} verrà eliminato da Ente.";
  ...
  static String m71(endDate) => "L\'abbonamento verrà cancellato il ${endDate}";
  ...
  static String m74(email) => "Questo è l\'ID di verifica di ${email}";
  ...
  static String m76(count) => "Conservando ${count} ricordi...";

  static String m77(endDate) => "Valido fino al ${endDate}";

  static String m78(email) => "Verifica ${email}";
