...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m56(endpoint) => "Verbonden met ${endpoint}";
  ...
  static String m58(newEmail) => "E-mailadres gewijzigd naar ${newEmail}";

  static String m59(email) => "${email} heeft geen Ente account.";

  static String m12(email) =>
      "${email} heeft geen Ente account.\n\nStuur ze een uitnodiging om foto\'s te delen.";

  static String m60(name) => "${name} omarmen";

  static String m61(text) => "Extra foto\'s gevonden voor ${text}";

  static String m62(name) => "Feestmaal met ${name}";
  ...
  static String m66(sizeInMBorGB) => "Maak ${sizeInMBorGB} vrij";

  static String m68(currentlyProcessing, totalCount) =>
      "Verwerken van ${currentlyProcessing} / ${totalCount}";

  static String m69(name) => "Wandelen met ${name}";

  static String m15(count) =>
      "${Intl.plural(count, one: '${count} item', other: '${count} items')}";

  static String m70(name) => "Laatste keer met ${name}";
  ...
  static String m72(email) => "Link persoon aan ${email}";

  static String m73(personName, email) =>
      "Dit linkt ${personName} aan ${email}";

  static String m76(albumName) => "Succesvol verplaatst naar ${albumName}";

  static String m77(personName) => "Geen suggesties voor ${personName}";

  static String m78(name) => "Niet ${name}?";

  static String m17(familyAdminEmail) =>
      "Neem contact op met ${familyAdminEmail} om uw code te wijzigen.";

  static String m79(name) => "Feest met ${name}";
  ...
  static String m81(name, age) => "${name} wordt binnenkort ${age}";
  ...
  static String m83(toEmail) => "Stuur ons een e-mail op ${toEmail}";

  static String m84(toEmail) =>
      "Verstuur de logboeken alstublieft naar ${toEmail}";

  static String m85(name) => "Poseren met ${name}";

  static String m86(folderName) => "Verwerken van ${folderName}...";

  static String m21(storeName) => "Beoordeel ons op ${storeName}";

  static String m87(name) => "Toegewezen aan ${name}";
  ...
  static String m90(email) => "${email} probeert je account te herstellen.";
  ...
  static String m91(name) => "Roadtrip met ${name}";
  ...
  static String m94(name) => "Selfies met ${name}";
  ...
  static String m95(emailIDs) => "Gedeeld met ${emailIDs}";
  ...
  static String m96(name) => "Sporten met ${name}";

  static String m97(name) => "Spotlicht op ${name}";
