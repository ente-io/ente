...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m24(endpoint) => "Verbonden met ${endpoint}";
  ...
  static String m31(newEmail) => "E-mailadres gewijzigd naar ${newEmail}";
  ...
  static String m46(name) => "Niet ${name}?";
  ...
  static String m73(count) => "${count} herinneringen veiligstellen...";

  static String m74(endDate) => "Geldig tot ${endDate}";

  static String m75(email) => "Verifieer ${email}";
