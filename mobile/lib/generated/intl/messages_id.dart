...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m24(endpoint) => "Terhubung ke ${endpoint}";
  ...
  static String m31(newEmail) => "Email diubah menjadi ${newEmail}";
  ...
  static String m71(email) => "Ini adalah ID Verifikasi milik ${email}";
  ...
  static String m74(endDate) => "Berlaku hingga ${endDate}";

  static String m75(email) => "Verifikasi ${email}";
