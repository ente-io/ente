...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m58(newEmail) => "Email alterado para ${newEmail}";

  static String m12(email) =>
      "${email} não possui uma conta Ente.\n\nEnvie um convite para compartilhar fotos.";

  static String m61(text) => "Fotos extras encontradas para ${text}";
  ...
  static String m66(sizeInMBorGB) => "Libertar ${sizeInMBorGB}";
  ...
  static String m84(toEmail) => "Por favor, envie os logs para \n${toEmail}";
