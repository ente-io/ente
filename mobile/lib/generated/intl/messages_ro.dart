...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m56(endpoint) => "Conectat la ${endpoint}";
  ...
  static String m58(newEmail) => "E-mail modificat în ${newEmail}";

  static String m12(email) =>
      "${email} nu are un cont Ente.\n\nTrimiteți-le o invitație pentru a distribui fotografii.";

  static String m61(text) => "S-au găsit fotografii extra pentru ${text}";
  ...
  static String m66(sizeInMBorGB) => "Eliberați ${sizeInMBorGB}";
  ...
  static String m76(albumName) => "S-au mutat cu succes în ${albumName}";

  static String m77(personName) => "Nicio sugestie pentru ${personName}";

  static String m78(name) => "Nu este ${name}?";
  ...
  static String m86(folderName) => "Se procesează ${folderName}...";
  ...
  static String m90(email) => "${email} încearcă să vă recupereze contul.";
  ...
  static String m95(emailIDs) => "Distribuit cu ${emailIDs}";
