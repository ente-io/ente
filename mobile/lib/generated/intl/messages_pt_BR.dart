...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m50(name) => "Admirando ${name}";
  ...
  static String m53(name) => "Vistas bonitas com ${name}";
  ...
  static String m56(endpoint) => "Conectado à ${endpoint}";
  ...
  static String m58(newEmail) => "E-mail alterado para ${newEmail}";

  static String m59(email) => "${email} não possui uma conta Ente.";

  static String m12(email) =>
      "${email} não tem uma conta Ente.\n\nEnvie-os um convite para compartilhar fotos.";

  static String m60(name) => "Abraçando ${name}";

  static String m61(text) => "Fotos adicionais encontradas para ${text}";

  static String m62(name) => "Tendo banquete com ${name}";
  ...
  static String m69(name) => "Caminhando com ${name}";

  static String m15(count) =>
      "${Intl.plural(count, one: '${count} item', other: '${count} itens')}";

  static String m70(name) => "Últimos momentos com ${name}";
  ...
  static String m72(email) => "Vincular pessoa a ${email}";
  ...
  static String m76(albumName) => "Movido com sucesso para ${albumName}";

  static String m77(personName) => "Sem sugestões para ${personName}";

  static String m78(name) => "Não é ${name}?";

  static String m17(familyAdminEmail) =>
      "Entre em contato com ${familyAdminEmail} para alterar o seu código.";

  static String m79(name) => "Festejando com ${name}";
  ...
  static String m80(name, age) => "${name} está com ${age}!";

  static String m81(name, age) => "${name} terá ${age} em breve";
  ...
  static String m83(toEmail) => "Envie-nos um e-mail para ${toEmail}";

  static String m84(toEmail) => "Envie os registros para \n${toEmail}";

  static String m85(name) => "Fazendo pose com ${name}";

  static String m86(folderName) => "Processando ${folderName}...";

  static String m21(storeName) => "Avalie-nos no ${storeName}";

  static String m87(name) => "Atribuído a ${name}";
  ...
  static String m90(email) => "${email} está tentando recuperar sua conta.";
  ...
  static String m24(endDate) => "Renovação de assinatura em ${endDate}";

  static String m91(name) => "Viajando de carro com ${name}";
  ...
  static String m94(name) => "Tirando selfies com ${name}";
  ...
  static String m95(emailIDs) => "Compartilhado com ${emailIDs}";
  ...
  static String m33(fileType) => "Este ${fileType} será excluído do Ente.";

  static String m96(name) => "Jogando esportes com ${name}";

  static String m97(name) => "Destacar ${name}";
  ...
  static String m36(endDate) => "Sua assinatura será cancelada em ${endDate}";
