...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m8(albumName) => "${albumName} に追加しました";

  static String m9(count) =>
      "${Intl.plural(count, zero: '参加者なし', one: '1 参加者', other: '${count} 参加者')}";

  static String m10(versionValue) => "バージョン: ${versionValue}";
  ...
  static String m18(endpoint) => "${endpoint} に接続しました";
  ...
  static String m21(albumName) => "\"${albumName}\" にアクセスするための公開リンクが削除されます。";
  ...
  static String m25(newEmail) => "メールアドレスが ${newEmail} に変更されました";
  ...
  static String m30(endDate) => "無料トライアルは${endDate} までです";

  static String m31(count) =>
      "あなたが有効なサブスクリプションを持っている限りEnte上の ${Intl.plural(count, other: 'それらに')} アクセスできます";

  static String m32(sizeInMBorGB) => "${sizeInMBorGB} を解放する";
  ...
  static String m35(count) => "${Intl.plural(count, other: '${count}個のアイテム')}";
  ...
  static String m38(albumName) => "${albumName} に移動しました";

  static String m39(name) => "${name} ではありませんか？";
  ...
  static String m42(providerName) => "請求された場合は、 ${providerName} のサポートに連絡してください";

  static String m43(endDate) =>
      "${endDate} まで無料トライアルが有効です。\nその後、有料プランを選択することができます。";

  static String m44(toEmail) => "${toEmail} にメールでご連絡ください";

  static String m45(toEmail) => "ログを以下のアドレスに送信してください \n${toEmail}";

  static String m47(storeName) => "${storeName} で評価";

  static String m48(storageInGB) => "3. お二人とも ${storageInGB} GB*を無料で手に入ります。";

  static String m49(userEmail) =>
      "${userEmail} はこの共有アルバムから退出します\n\n${userEmail} が追加した写真もアルバムから削除されます";

  static String m50(endDate) => "サブスクリプションは ${endDate} に更新します";
  ...
  static String m52(count, yourCount) => "${count} 個選択中（${yourCount} あなた）";

  static String m53(verificationID) => "私の確認ID: ente.ioの ${verificationID}";
  ...
  static String m56(emailIDs) => "${emailIDs} と共有中";

  static String m57(fileType) => "${fileType} はEnteから削除されます。";

  static String m58(fileType) => "この ${fileType} はEnteとお使いのデバイスの両方にあります。";
  ...
  static String m61(
      ...
      "${usedAmount} ${usedStorageUnit} の ${totalAmount} ${totalStorageUnit} が使用されました";

  static String m62(id) =>
      "あなたの ${id} はすでに別のEnteアカウントにリンクされています。\nこのアカウントであなたの ${id} を使用したい場合は、サポートにお問い合わせください。";

  static String m63(endDate) => "サブスクリプションは ${endDate} でキャンセルされます";

  static String m64(completed, total) => "${completed}/${total} のメモリが保存されました";

  static String m65(storageAmountInGB) => "紹介者も ${storageAmountInGB} GB を得ます";

  static String m66(email) => "これは ${email} の確認用ID";

  static String m67(count) =>
      "${Intl.plural(count, zero: '', one: '1日', other: '${count} 日')}";

  static String m68(count) => "${count} メモリを保存しています...";

  static String m69(endDate) => "${endDate} まで";

  static String m70(email) => "${email} を確認";

  static String m71(email) => "<green>${email}</green>にメールを送りました";

  static String m72(count) =>
      "${Intl.plural(count, one: '${count} 年前', other: '${count} 年前')}";

  static String m73(storageSaved) => "${storageSaved} を解放しました";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "appLockDescriptions": MessageLookupByLibrary.simpleMessage(
            "デバイスのデフォルトのロック画面と、カスタムロック画面を選択します。"),
        "appVersion": m10,
        ...
        "archive": MessageLookupByLibrary.simpleMessage("アーカイブする"),
        ...
        "collabLinkSectionDescription": MessageLookupByLibrary.simpleMessage(
            "Enteアプリやアカウントを必要とせずに、共有アルバムに写真を追加したり表示したりできるリンクを作成します。"),
        ...
        "collectEventPhotos":
            MessageLookupByLibrary.simpleMessage("イベントの写真を収集する"),
        "collectPhotos": MessageLookupByLibrary.simpleMessage("写真を集める"),
        ...
        "deleteFromBoth": MessageLookupByLibrary.simpleMessage("Enteから削除"),
        ...
        "doubleYourStorage":
            MessageLookupByLibrary.simpleMessage("ストレージを倍にしましょう"),
        ...
        "howItWorks": MessageLookupByLibrary.simpleMessage("仕組み"),
        ...
        "leaveSharedAlbum": MessageLookupByLibrary.simpleMessage("共有アルバムを抜ける"),
        ...
        "linkNeverExpires": MessageLookupByLibrary.simpleMessage("絶対になし"),
        ...
        "manageDeviceStorage":
            MessageLookupByLibrary.simpleMessage("デバイスのストレージを管理"),
        ...
        "nothingSharedWithYouYet":
            MessageLookupByLibrary.simpleMessage("あなたと共有されたものはありません"),
        "nothingToSeeHere":
        ...
        "recoveryKeyOnForgotPassword": MessageLookupByLibrary.simpleMessage(
            "パスワードを忘れてしまったら、このリカバリーキーが唯一あなたのデータを復元できます"),
        "recoveryKeySaveDescription": MessageLookupByLibrary.simpleMessage(
            "リカバリーキーは私達も保管しません。24語の単語たちを安全な場所に保管してください"),
        ...
        "recoveryKeyVerifyReason": MessageLookupByLibrary.simpleMessage(
            "パスワードを忘れた場合、リカバリキーは写真を復元する唯一の方法です。 リカバリキーは、設定 > セキュリティ で見つけることができます。\n\nリカバリーキーをここに入力して、正しく保存したことを確認してください。"),
        "recoverySuccessful":
        ...
        "referFriendsAnd2xYourPlan":
            MessageLookupByLibrary.simpleMessage("友達に紹介してあなたのプランを2倍にしよう"),
        "referralStep1":
        ...
        "searchCaptionEmptySection": MessageLookupByLibrary.simpleMessage(
            "写真情報に \"#trip\" のように説明を追加して、簡単に見つけられます"),
        ...
        "selectItemsToAdd": MessageLookupByLibrary.simpleMessage("追加するアイテムを選択"),
        ...
        "selectYourPlan": MessageLookupByLibrary.simpleMessage("プランを選択してください"),
        ...
        "shareWithNonenteUsers":
            MessageLookupByLibrary.simpleMessage("Enteアカウントを持っていないユーザーと共有"),
        ...
        "sharedWith": m56,
        "sharedWithMe": MessageLookupByLibrary.simpleMessage("あなたに共有されています"),
        ...
        "someoneSharingAlbumsWithYouShouldSeeTheSameId":
            MessageLookupByLibrary.simpleMessage(
                "アルバムを共有している人はデバイス上で同じIDを見ることができます。"),
        "somethingWentWrong":
