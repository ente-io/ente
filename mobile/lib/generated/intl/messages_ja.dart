...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m24(endpoint) => "${endpoint} に接続しました";
  ...
  static String m27(albumName) => "\"${albumName}\" にアクセスするための公開リンクが削除されます。";
  ...
  static String m31(newEmail) => "メールアドレスが ${newEmail} に変更されました";
  ...
  static String m43(expiryTime) => "リンクは ${expiryTime} に期限切れになります";
  ...
  static String m45(albumName) => "${albumName} に移動しました";

  static String m46(name) => "${name} ではありませんか？";
  ...
  static String m48(providerName) => "請求された場合は、 ${providerName} のサポートに連絡してください";
  ...
  static String m58(count, yourCount) => "${count} 個選択中（${yourCount} あなた）";

  static String m59(verificationID) => "私の確認ID: ente.ioの ${verificationID}";
  ...
  static String m62(emailIDs) => "${emailIDs} と共有中";

  static String m63(fileType) => "${fileType} はEnteから削除されます。";

  static String m64(fileType) => "この ${fileType} はEnteとお使いのデバイスの両方にあります。";

  static String m65(fileType) => "${fileType} はEnteから削除されます。";
  ...
  static String m68(endDate) => "サブスクリプションは ${endDate} でキャンセルされます";

  static String m69(completed, total) => "${completed}/${total} のメモリが保存されました";

  static String m0(ignoreReason) =>
      "Tap to upload, upload is currently ignored due to ${ignoreReason}";

  static String m70(storageAmountInGB) => "紹介者も ${storageAmountInGB} GB を得ます";

  static String m71(email) => "これは ${email} の確認用ID";
  ...
  static String m73(count) => "${count} メモリを保存しています...";

  static String m74(endDate) => "${endDate} まで";

  static String m75(email) => "${email} を確認";

  static String m5(email) => "<green>${email}</green>にメールを送りました";

  static String m76(count) =>
      "${Intl.plural(count, one: '${count} 年前', other: '${count} 年前')}";

  static String m77(storageSaved) => "${storageSaved} を解放しました";
