...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m7(emailOrName) => "Додано ${emailOrName}";

  static String m8(albumName) => "Успішно додано до «${albumName}»";
  ...
  static String m18(endpoint) => "Під\'єднано до ${endpoint}";
  ...
  static String m25(newEmail) => "Поштову адресу змінено на ${newEmail}";
  ...
  static String m30(endDate) => "Безплатна пробна версія діє до ${endDate}";

  static String m31(count) =>
      "Ви все ще можете отримати доступ до ${Intl.plural(count, one: 'нього', other: 'них')} в Ente, доки у вас активна підписка";

  static String m32(sizeInMBorGB) => "Звільніть ${sizeInMBorGB}";
  ...
  static String m36(expiryTime) => "Посилання закінчується через ${expiryTime}";
  ...
  static String m38(albumName) => "Успішно перенесено до «${albumName}»";

  static String m39(name) => "Не ${name}?";
  ...
  static String m44(toEmail) => "Напишіть нам на ${toEmail}";

  static String m45(toEmail) => "Надішліть журнали на \n${toEmail}";

  static String m46(folderName) => "Оброблюємо «${folderName}»...";

  static String m47(storeName) => "Оцініть нас в ${storeName}";
  ...
  static String m50(endDate) => "Підписка поновиться ${endDate}";
  ...
  static String m1(count) => "${count} вибрано";

  static String m52(count, yourCount) => "${count} вибрано (${yourCount} ваші)";
  ...
  static String m56(emailIDs) => "Поділилися з ${emailIDs}";

  static String m57(fileType) => "Цей ${fileType} буде видалено з пристрою.";

  static String m58(fileType) =>
      "Цей ${fileType} знаходиться і в Ente, і на вашому пристрої.";

  static String m59(fileType) => "Цей ${fileType} буде видалено з Ente.";

  static String m60(storageAmountInGB) => "${storageAmountInGB} ГБ";
  ...
  static String m63(endDate) => "Вашу підписку буде скасовано ${endDate}";

  static String m64(completed, total) =>
      "${completed} / ${total} спогадів збережено";

  static String m65(storageAmountInGB) =>
      "Вони також отримують ${storageAmountInGB} ГБ";

  static String m66(email) => "Це ідентифікатор підтвердження пошти ${email}";

  static String m67(count) =>
      "${Intl.plural(count, zero: '', one: '1 день', few: '${count} дні', many: '${count} днів', other: '${count} днів')}";

  static String m68(count) =>
      "${Intl.plural(count, few: 'Зберігаємо ${count} спогади...', many: 'Зберігаємо ${count} спогадів...', other: '')}";

  static String m69(endDate) => "Діє до ${endDate}";

  static String m70(email) => "Підтвердити ${email}";

  static String m71(email) => "Ми надіслали листа на <green>${email}</green>";

  static String m72(count) =>
      "${Intl.plural(count, one: '${count} рік тому', few: '${count} роки тому', many: '${count} років тому', other: '${count} років тому')}";

  static String m73(storageSaved) => "Ви успішно звільнили ${storageSaved}!";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "descriptions": MessageLookupByLibrary.simpleMessage("Описи"),
        ...
        "favorite": MessageLookupByLibrary.simpleMessage("В улюблене"),
        ...
        "flip": MessageLookupByLibrary.simpleMessage("Перевернути"),
        "forYourMemories":
        ...
        "manageDeviceStorage":
            MessageLookupByLibrary.simpleMessage("Керування сховищем пристрою"),
        "manageFamily":
        ...
        "reviewDeduplicateItems": MessageLookupByLibrary.simpleMessage(
            "Перегляньте та видаліть елементи, які ви вважаєте, є дублікатами."),
        "reviewSuggestions":
        ...
        "usableReferralStorageInfo": MessageLookupByLibrary.simpleMessage(
            "Доступний обсяг пам\'яті обмежений вашим поточним тарифом. Надлишок заявленого обсягу автоматично стане доступним, коли ви покращте тариф."),
        "useAsCover":
