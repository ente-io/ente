...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m57(toEmail) => "Напишіть нам на ${toEmail}";

  static String m58(toEmail) => "Надішліть журнали на \n${toEmail}";

  static String m59(folderName) => "Оброблюємо «${folderName}»...";

  static String m60(storeName) => "Оцініть нас в ${storeName}";
  ...
  static String m67(endDate) => "Передплата поновиться ${endDate}";
  ...
  static String m70(count, yourCount) => "${count} вибрано (${yourCount} ваші)";
  ...
  static String m75(fileType) => "Цей ${fileType} буде видалено з пристрою.";

  static String m76(fileType) =>
      "Цей ${fileType} знаходиться і в Ente, і на вашому пристрої.";

  static String m77(fileType) => "Цей ${fileType} буде видалено з Ente.";
  ...
  static String m80(endDate) => "Вашу передплату буде скасовано ${endDate}";
  ...
  static String m83(email) => "Це ідентифікатор підтвердження пошти ${email}";
  ...
  static String m88(count) => "Збереження ${count} спогадів...";

  static String m89(endDate) => "Діє до ${endDate}";

  static String m90(email) => "Підтвердити ${email}";
  ...
  static String m93(storageSaved) => "Ви успішно звільнили ${storageSaved}!";
