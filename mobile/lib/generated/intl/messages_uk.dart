...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m26(endpoint) => "Під\'єднано до ${endpoint}";
  ...
  static String m33(newEmail) => "Поштову адресу змінено на ${newEmail}";

  static String m35(email) =>
      "У ${email} немає облікового запису Ente.\n\nНадішліть їм запрошення для обміну фотографіями.";

  static String m37(text) => "Знайдено додаткові фотографії для ${text}";
  ...
  static String m41(endDate) => "Безплатна пробна версія діє до ${endDate}";

  static String m42(count) =>
      "Ви все ще можете отримати доступ до ${Intl.plural(count, one: 'нього', other: 'них')} в Ente, доки у вас активна передплата";

  static String m43(sizeInMBorGB) => "Звільніть ${sizeInMBorGB}";
  ...
  static String m49(email) => "${email} запросив вас стати довіреною особою";

  static String m50(expiryTime) => "Посилання закінчується через ${expiryTime}";
  ...
  static String m54(albumName) => "Успішно перенесено до «${albumName}»";

  static String m55(personName) => "Немає пропозицій для ${personName}";
  ...
  static String m85(fileType) => "Цей ${fileType} буде видалено з пристрою.";

  static String m86(fileType) =>
      "Цей ${fileType} знаходиться і в Ente, і на вашому пристрої.";

  static String m87(fileType) => "Цей ${fileType} буде видалено з Ente.";
  ...
  static String m95(email) => "Це ідентифікатор підтвердження пошти ${email}";
  ...
  static String m104(count) => "Збереження ${count} спогадів...";

  static String m105(endDate) => "Діє до ${endDate}";

  static String m106(email) => "Підтвердити ${email}";
  ...
  static String m110(storageSaved) => "Ви успішно звільнили ${storageSaved}!";
