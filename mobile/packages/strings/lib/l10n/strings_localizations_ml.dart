...
class StringsLocalizationsMl extends StringsLocalizations {
  StringsLocalizationsMl([String locale = 'ml']) : super(locale);
  ...
  @override
  String get verifyPassword => 'പാസ്‌വേഡ് സ്ഥിരീകരിക്കുക';

  @override
  String get incorrectPasswordTitle => 'തെറ്റായ പാസ്‌വേഡ്';
  ...
  @override
  String get twoFactorAuthTitle => 'ടു-ഫാക്ടർ ആധികാരികത';

  @override
  String get enterCodeHint =>
      'നിങ്ങളുടെ ഓതന്റിക്കേറ്റർ ആപ്പിൽ നിന്നുള്ള 6 അക്ക കോഡ് നൽകുക';
  ...
  String get emailAlreadyRegistered =>
      'ഇമെയിൽ ഇതിനകം രജിസ്റ്റർ ചെയ്തിട്ടുണ്ട്.';

  @override
  String get emailNotRegistered => 'ഇമെയിൽ രജിസ്റ്റർ ചെയ്തിട്ടില്ല.';
