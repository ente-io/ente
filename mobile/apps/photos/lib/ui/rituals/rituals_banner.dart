    ...
    return ValueListenableBuilder<RitualsState>(
      ...
      builder: (context, state, _) {
        ...
        return Column(
          ...
          children: [
            _RitualsHeader(
              onTap: () => routeToPage(context, const AllRitualsScreen()),
            ),
            const SizedBox(height: 2),
            if (rituals.isEmpty)
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 12),
                child: _StartNewRitualCard(
                  variant: _StartNewRitualCardVariant.wide,
                  onTap: () async {
  ...
  List<Widget> _buildRowItems(
    ...
    return [
      ...
      if (rituals.isNotEmpty)
        _StartNewRitualCard(
          variant: _StartNewRitualCardVariant.compact,
...
class _RitualsHeader extends StatelessWidget {
  const _RitualsHeader({required this.onTap});
...
enum _StartNewRitualCardVariant { compact, wide }

class _StartNewRitualCard extends StatelessWidget {
  const _StartNewRitualCard({
    required this.variant,
    required this.onTap,
  });

  final _StartNewRitualCardVariant variant;
  final VoidCallback onTap;
  ...
  Widget build(BuildContext context) {
    ...
    final contentRightPadding =
        variant == _StartNewRitualCardVariant.compact ? 14.0 : 0.0;
    ...
    final content = Row(
      children: [
        ...
        if (variant == _StartNewRitualCardVariant.wide)
          SizedBox(
    ...
    return SizedBox(
      width:
          variant == _StartNewRitualCardVariant.compact ? _compactWidth : null,
      height: _cardHeight,
      child: DottedBorder(
