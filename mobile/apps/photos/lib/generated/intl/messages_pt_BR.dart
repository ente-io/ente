...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m8(name) => "Admirando ${name}";
  ...
  static String m12(name) => "Vistas bonitas com ${name}";
  ...
  static String m21(endpoint) => "Conectado à ${endpoint}";
  ...
  static String m29(name) => "Este e-mail já está vinculado a ${name}.";

  static String m30(newEmail) => "E-mail alterado para ${newEmail}";

  static String m31(email) => "${email} não possui uma conta Ente.";

  static String m32(email) =>
      "${email} não tem uma conta Ente.\n\nEnvie-os um convite para compartilhar fotos.";

  static String m33(name) => "Abraçando ${name}";

  static String m34(text) => "Fotos adicionais encontradas para ${text}";

  static String m35(name) => "Tendo banquete com ${name}";
  ...
  static String m39(endDate) => "A avaliação grátis acaba em ${endDate}";

  static String m40(count) =>
      "Você ainda pode acessá${Intl.plural(count, one: '-lo', other: '-los')} no Ente se você tiver uma assinatura ativa";

  static String m41(sizeInMBorGB) => "Liberar ${sizeInMBorGB}";
  ...
  static String m65(toEmail) => "Envie-nos um e-mail para ${toEmail}";

  static String m66(toEmail) => "Envie os registros para \n${toEmail}";

  static String m67(name) => "Fazendo pose com ${name}";

  static String m68(folderName) => "Processando ${folderName}...";

  static String m69(storeName) => "Avalie-nos no ${storeName}";
  ...
  static String m76(endDate) => "Renovação de assinatura em ${endDate}";
  ...
  static String m88(emailIDs) => "Compartilhado com ${emailIDs}";
  ...
  static String m91(fileType) => "Este ${fileType} será excluído do Ente.";

  static String m92(name) => "Jogando esportes com ${name}";

  static String m93(name) => "Destaques em ${name}";
  ...
  static String m97(endDate) => "Sua assinatura será cancelada em ${endDate}";
  ...
  static String m110(count) => "Preservando ${count} memórias...";

  static String m111(endDate) => "Válido até ${endDate}";

  static String m112(email) => "Verificar ${email}";

  static String m113(name) => "Visualizar ${name} para desvincular";
  ...
  static String m115(email) => "Enviamos um e-mail à <green>${email}</green>";

  static String m116(name) => "Deseje um feliz aniversário a ${name}! 🎉";

  static String m117(count) =>
      "${Intl.plural(count, one: '${count} ano atrás', other: '${count} anos atrás')}";

  static String m118(name) => "Você e ${name}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "addedToAlbums": m7,
    "addingPhotos": MessageLookupByLibrary.simpleMessage("Adicionando fotos"),
    ...
    "cLDesc1": MessageLookupByLibrary.simpleMessage(
      "Estamos lançando um novo editor de fotos avançado que adiciona mais quadros de recorte, predefinições de filtro para edições rápidas, ajustes para afinação incluindo saturação, contraste, brilho, temperatura e mais. O novo editor também incluí a habilidade de desenhar em suas fotos e adicionar emojis como figurinhas.",
    ),
    "cLDesc2": MessageLookupByLibrary.simpleMessage(
      "Você agora pode adicionar automaticamente fotos de pessoas selecionadas para qualquer álbum. É só ir ao álbum, selecionar \"adicionar pessoa auto.\" no menu avançado. Se usado junto ao álbum compartilhado, você pode compartilhar fotos sem maior esforço.",
    ),
    "cLDesc3": MessageLookupByLibrary.simpleMessage(
      "Adicionamos a habilidade de agrupar sua galeria por semanas, meses, e anos. Você pode personalizar sua galeria para parecer exatamente a maneira que desejar usando as novas opções de agrupamento, junto às grades personalizadas",
    ),
    "cLDesc4": MessageLookupByLibrary.simpleMessage(
      "Junto ao tanto de melhorias salva-vidas para melhorar a experiência de arraste na galeria, também redesenhamos a barra de deslize para exibir marcadores, permitindo você pular a timeline rapidamente.",
    ),
    ...
    "cLTitle4": MessageLookupByLibrary.simpleMessage("Arrastar Rápido"),
    ...
    "editAutoAddPeople": MessageLookupByLibrary.simpleMessage(
      "Editar adição automática de pessoas",
    ),
    ...
    "genericProgress": m43,
    "gettingReady": MessageLookupByLibrary.simpleMessage("Preparando"),
    ...
    "onlyThem": MessageLookupByLibrary.simpleMessage("Apenas ele"),
    ...
    "peopleAutoAddDesc": MessageLookupByLibrary.simpleMessage(
      "Selecione as pessoas que deseja adicionar automaticamente ao álbum",
    ),
    ...
    "processed": MessageLookupByLibrary.simpleMessage("Processado(s)"),
    ...
    "sticker": MessageLookupByLibrary.simpleMessage("Figurinha"),
