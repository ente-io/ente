...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m8(name) => "${name}に注目！";
  ...
  static String m12(name) => "${name}と見た美しい景色！";
  ...
  static String m16(albumName) => "${albumName} のコラボレーションリンクを生成しました";
  ...
  static String m31(email) => "${email} は Ente アカウントを持っていません。";

  static String m32(email) =>
      "${email} はEnteアカウントを持っていません。\n\n写真を共有するために「招待」を送信してください。";

  static String m33(name) => "${name}抱きしめて！";

  static String m34(text) => "${text} の写真が見つかりました";

  static String m35(name) => "${name}とご飯！";
  ...
  static String m118(name) => "あなたと${name}";

  static String m119(storageSaved) => "${storageSaved} を解放しました";
