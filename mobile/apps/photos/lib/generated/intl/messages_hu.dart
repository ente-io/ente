...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m48(expiryTime) => "Hivatkozás lejár ${expiryTime} ";
  ...
  static String m81(count) => "${count} kiválasztott";
  ...
  static String m91(fileType) => "Ez a ${fileType} fájl törlődik az Ente-ből.";
  ...
  static String m101(email) => "Ez ${email} ellenőrző azonosítója";
