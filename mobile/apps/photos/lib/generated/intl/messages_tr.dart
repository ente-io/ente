...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m29(name) => "Bu e-posta zaten ${name} kişisine bağlı.";

  static String m30(newEmail) => "E-posta ${newEmail} olarak değiştirildi";

  static String m31(email) => "${email} bir Ente hesabına sahip değil";

  static String m32(email) =>
      "${email}, Ente hesabı bulunmamaktadır.\n\nOnlarla fotoğraf paylaşımı için bir davet gönder.";

  static String m33(name) => "${name}\'e sarılmak";

  static String m34(text) => "${text} için ekstra fotoğraflar bulundu";

  static String m35(name) => "${name} ile ziyafet";
  ...
  static String m44(name) => "${name} ile doğa yürüyüşü";

  static String m45(count) =>
      "${Intl.plural(count, one: '${count} öğe', other: '${count} öğeler')}";

  static String m46(name) => "${name} ile son an";
  ...
  static String m49(email) => "Kişiyi ${email} adresine bağlayın";
  ...
  static String m53(albumName) => "${albumName} adlı albüme başarıyla taşındı";

  static String m54(personName) => "${personName} için öneri yok";

  static String m55(name) => "${name} değil mi?";

  static String m56(familyAdminEmail) =>
      "Kodunuzu değiştirmek için lütfen ${familyAdminEmail} ile iletişime geçin.";

  static String m57(name) => "${name} ile parti";
  ...
  static String m60(name, age) => "${name} ${age} yaşında!";

  static String m61(name, age) => "${name} yakında ${age} yaşına giriyor";
  ...
  static String m65(toEmail) => "Lütfen bize ${toEmail} adresinden ulaşın";

  static String m66(toEmail) =>
      "Lütfen kayıtları şu adrese gönderin\n${toEmail}";

  static String m67(name) => "${name} ile poz verme";

  static String m68(folderName) => "İşleniyor ${folderName}...";

  static String m69(storeName) => "Bizi ${storeName} üzerinden değerlendirin";

  static String m70(name) => "Sizi ${name}\'e yeniden atadı";
  ...
  static String m73(email) => "${email} hesabınızı kurtarmaya çalışıyor.";

  static String m74(storageInGB) => "3. İkinizde bedava ${storageInGB} GB alın";
  ...
  static String m76(endDate) => "Abonelik ${endDate} tarihinde yenilenir";

  static String m77(name) => "${name} ile yolculuk";
  ...
  static String m81(count) => "${count} seçildi";

  static String m82(count, yourCount) =>
      "Seçilenler: ${count} (${yourCount} sizin seçiminiz)";

  static String m83(name) => "${name} ile selfieler";
  ...
  static String m88(emailIDs) => "${emailIDs} ile paylaşıldı";

  static String m89(fileType) => "Bu ${fileType}, cihazınızdan silinecek.";

  static String m90(fileType) =>
      "${fileType} Ente ve cihazınızdan silinecektir.";

  static String m91(fileType) => "${fileType} Ente\'den silinecektir.";

  static String m92(name) => "${name} ile spor";

  static String m93(name) => "Sahne ${name}\'in";
  ...
  static String m98(completed, total) => "${completed}/${total} anı korundu";
  ...
  static String m101(email) => "Bu, ${email}\'in Doğrulama Kimliği";

  static String m102(count) =>
      "${Intl.plural(count, one: 'Bu hafta, ${count} yıl önce', other: 'Bu hafta, ${count} yıl önce')}";

  static String m103(dateFormat) => "${dateFormat} yıllar boyunca";

  static String m104(count) =>
      "${Intl.plural(count, zero: 'Yakında', one: '1 gün', other: '${count} gün')}";

  static String m105(year) => "${year} yılındaki gezi";

  static String m106(location) => "${location}\'a gezi";
  ...
  static String m110(count) => "${count} anı korunuyor...";

  static String m111(endDate) => "${endDate} tarihine kadar geçerli";

  static String m112(email) => "${email} doğrula";
  ...
  static String m116(name) => "${name} doğum günü kutlu olsun! 🎉";

  static String m117(count) =>
      "${Intl.plural(count, one: '${count} yıl önce', other: '${count} yıl önce')}";

  static String m118(name) => "Sen ve ${name}";
