...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m15(isFamilyMember, storageAmountInGb) =>
      "${Intl.select(isFamilyMember, {'true': 'קיבלת ${storageAmountInGb} GB עד כה', 'false': 'קיבלת ${storageAmountInGb} GB עד כה', 'other': 'קיבלת ${storageAmountInGb} GB עד כה!'})}";
  ...
  static String m119(storageSaved) => "הצלחת לפנות ${storageSaved}!";

  final messages = _notInlinedMessages(_notInlinedMessages);
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    "about": MessageLookupByLibrary.simpleMessage("אודות"),
    "account": MessageLookupByLibrary.simpleMessage("חשבון"),
    "accountWelcomeBack": MessageLookupByLibrary.simpleMessage("ברוך שובך!"),
    ...
    "activeSessions": MessageLookupByLibrary.simpleMessage("חיבורים פעילים"),
    "addANewEmail": MessageLookupByLibrary.simpleMessage("הוסף דוא\"ל חדש"),
    "addCollaborator": MessageLookupByLibrary.simpleMessage("הוסף משתף פעולה"),
    ...
    "allowPeopleToAddPhotos": MessageLookupByLibrary.simpleMessage(
      "תן לאנשים להוסיף תמונות",
    ),
    "androidBiometricSuccess": MessageLookupByLibrary.simpleMessage("הצלחה"),
    ...
    "atAFalloutShelter": MessageLookupByLibrary.simpleMessage("במקלט גרעיני"),
    ...
    "changePasswordTitle": MessageLookupByLibrary.simpleMessage("שנה סיסמה"),
    ...
    "clubByFileName": MessageLookupByLibrary.simpleMessage("קבץ לפי שם הקובץ"),
    "codeAppliedPageTitle": MessageLookupByLibrary.simpleMessage("הקוד הוחל"),
    "codeCopiedToClipboard": MessageLookupByLibrary.simpleMessage(
      "הקוד הועתק ללוח",
    ),
    "codeUsedByYou": MessageLookupByLibrary.simpleMessage("הקוד שומש על ידיך"),
    ...
    "collageSaved": MessageLookupByLibrary.simpleMessage("הקולז נשמר לגלריה"),
    ...
    "createNewAccount": MessageLookupByLibrary.simpleMessage("צור חשבון חדש"),
    ...
    "deleteReason4": MessageLookupByLibrary.simpleMessage("הסיבה שלי לא כלולה"),
    "deleteRequestSLAText": MessageLookupByLibrary.simpleMessage(
      "הבקשה שלך תועבד תוך 72 שעות.",
    ),
    "deleteSharedAlbum": MessageLookupByLibrary.simpleMessage(
      "מחק את האלבום המשותף?",
    ),
    ...
    "disableTwofactor": MessageLookupByLibrary.simpleMessage("השבת דו-גורמי"),
    ...
    "enterReferralCode": MessageLookupByLibrary.simpleMessage("הזן קוד הפניה"),
    ...
    "exportYourData": MessageLookupByLibrary.simpleMessage("ייצוא הנתונים שלך"),
    ...
    "incorrectRecoveryKeyBody": MessageLookupByLibrary.simpleMessage(
      "המפתח שחזור שהזנת שגוי",
    ),
    "incorrectRecoveryKeyTitle": MessageLookupByLibrary.simpleMessage(
      "מפתח שחזור שגוי",
    ),
    "insecureDevice": MessageLookupByLibrary.simpleMessage("מכשיר בלתי מאובטח"),
    "installManually": MessageLookupByLibrary.simpleMessage("התקן באופן ידני"),
    ...
    "inviteYourFriends": MessageLookupByLibrary.simpleMessage("הזמן את חברייך"),
    "itemCount": m45,
    ...
    "linkHasExpired": MessageLookupByLibrary.simpleMessage("הקישור פג תוקף"),
    ...
    "noRecoveryKey": MessageLookupByLibrary.simpleMessage("אין מפתח שחזור?"),
    ...
    "peopleUsingYourCode": MessageLookupByLibrary.simpleMessage(
      "אנשים משתמשים בקוד שלך",
    ),
    "permanentlyDelete": MessageLookupByLibrary.simpleMessage("למחוק לצמיתות?"),
    "photoGridSize": MessageLookupByLibrary.simpleMessage("גודל לוח של התמונה"),
    ...
    "pleaseLoginAgain": MessageLookupByLibrary.simpleMessage("אנא התחבר שוב"),
    ...
    "privateBackups": MessageLookupByLibrary.simpleMessage("גיבויים פרטיים"),
    ...
    "removeDuplicates": MessageLookupByLibrary.simpleMessage("הסר כפילויות"),
    ...
    "removePublicLink": MessageLookupByLibrary.simpleMessage("הסר לינק ציבורי"),
    ...
    "resetPasswordTitle": MessageLookupByLibrary.simpleMessage("איפוס סיסמה"),
    "restore": MessageLookupByLibrary.simpleMessage("שחזר"),
    "restoreToAlbum": MessageLookupByLibrary.simpleMessage("שחזר לאלבום"),
    "restoringFiles": MessageLookupByLibrary.simpleMessage("משחזר קבצים..."),
    ...
    "searchByAlbumNameHint": MessageLookupByLibrary.simpleMessage("שם האלבום"),
    ...
    "selectedFoldersWillBeEncryptedAndBackedUp":
        MessageLookupByLibrary.simpleMessage("התיקיות שנבחרו יוצפנו ויגובו"),
    "selectedPhotos": m81,
    ...
    "sessionExpired": MessageLookupByLibrary.simpleMessage("פג תוקף החיבור"),
    ...
    "sortOldestFirst": MessageLookupByLibrary.simpleMessage("הישן ביותר קודם"),
    ...
    "suggestFeatures": MessageLookupByLibrary.simpleMessage("הציעו מאפיינים"),
    ...
    "unhideToAlbum": MessageLookupByLibrary.simpleMessage(
      "בטל הסתרה בחזרה לאלבום",
    ),
    "unhidingFilesToAlbum": MessageLookupByLibrary.simpleMessage(
      "מבטל הסתרת הקבצים לאלבום",
    ),
    ...
    "useRecoveryKey": MessageLookupByLibrary.simpleMessage("השתמש במפתח שחזור"),
    ...
    "viewRecoveryKey": MessageLookupByLibrary.simpleMessage("צפה במפתח השחזור"),
    "viewer": MessageLookupByLibrary.simpleMessage("צפיין"),
    "visitWebToManage": MessageLookupByLibrary.simpleMessage(
      "אנא בקר ב-web.ente.io על מנת לנהל את המנוי שלך",
    ),
    "weAreOpenSource": MessageLookupByLibrary.simpleMessage("הקוד שלנו פתוח!"),
    ...
    "youAreOnAFamilyPlan": MessageLookupByLibrary.simpleMessage(
      "אתה על תוכנית משפחתית!",
    ),
    "youAreOnTheLatestVersion": MessageLookupByLibrary.simpleMessage(
      "אתה על הגרסא הכי עדכנית",
    ),
    ...
    "yourPlanWasSuccessfullyDowngraded": MessageLookupByLibrary.simpleMessage(
      "התוכנית שלך שונמכה בהצלחה",
    ),
    "yourPlanWasSuccessfullyUpgraded": MessageLookupByLibrary.simpleMessage(
      "התוכנית שלך שודרגה בהצלחה",
    ),
