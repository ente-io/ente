...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m15(isFamilyMember, storageAmountInGb) =>
      "${Intl.select(isFamilyMember, {'true': 'Il tuo piano famiglia ha già richiesto ${storageAmountInGb} GB finora', 'false': 'Hai già richiesto ${storageAmountInGb} GB finora', 'other': 'Hai già richiesto ${storageAmountInGb} GB finora!'})}";

  static String m16(albumName) => "Link collaborativo creato per ${albumName}";
  ...
  static String m44(name) => "Escursioni con ${name}";

  static String m45(count) =>
      "${Intl.plural(count, one: '${count} elemento', other: '${count} elementi')}";

  static String m46(name) => "Ultima volta con ${name}";

  static String m47(email) =>
      "${email} ti ha invitato a essere un contatto fidato";

  static String m48(expiryTime) => "Il link scadrà il ${expiryTime}";

  static String m49(email) => "Collega persona a ${email}";
  ...
  static String m53(albumName) => "Spostato con successo su ${albumName}";

  static String m54(personName) => "Nessun suggerimento per ${personName}";

  static String m55(name) => "Non è ${name}?";

  static String m56(familyAdminEmail) =>
      "Per favore contatta ${familyAdminEmail} per cambiare il tuo codice.";

  static String m57(name) => "Festa con ${name}";
  ...
  static String m60(name, age) => "${name} ha ${age}!";

  static String m61(name, age) => "${name} sta per compiere ${age} anni";
  ...
  static String m65(toEmail) => "Per favore invia un\'email a ${toEmail}";

  static String m66(toEmail) => "Invia i log a \n${toEmail}";

  static String m67(name) => "In posa con ${name}";

  static String m68(folderName) => "Elaborando ${folderName}...";

  static String m69(storeName) => "Valutaci su ${storeName}";

  static String m70(name) => "Riassegnato a ${name}";
  ...
  static String m76(endDate) => "Si rinnova il ${endDate}";

  static String m77(name) => "Viaggio con ${name}";
  ...
  static String m81(count) => "${count} selezionati";

  static String m82(count, yourCount) =>
      "${count} selezionato (${yourCount} tuoi)";

  static String m83(name) => "Selfie con ${name}";
  ...
  static String m88(emailIDs) => "Condiviso con ${emailIDs}";
  ...
  static String m91(fileType) => "Questo ${fileType} verrà eliminato da Ente.";

  static String m92(name) => "Sport con ${name}";

  static String m93(name) => "Riflettori su ${name}";
  ...
  static String m97(endDate) => "L\'abbonamento verrà cancellato il ${endDate}";
  ...
  static String m110(count) => "Conservando ${count} ricordi...";

  static String m111(endDate) => "Valido fino al ${endDate}";

  static String m112(email) => "Verifica ${email}";

  static String m113(name) => "Visualizza ${name} per scollegare";
  ...
  static String m118(name) => "Tu e ${name}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "accountWelcomeBack": MessageLookupByLibrary.simpleMessage("Bentornato!"),
    ...
    "activeSessions": MessageLookupByLibrary.simpleMessage("Sessioni attive"),
    ...
    "addSelected": MessageLookupByLibrary.simpleMessage("Aggiungi selezionate"),
    "addToAlbum": MessageLookupByLibrary.simpleMessage("Aggiungi all\'album"),
    "addToEnte": MessageLookupByLibrary.simpleMessage("Aggiungi a Ente"),
    "addToHiddenAlbum": MessageLookupByLibrary.simpleMessage(
      "Aggiungi ad album nascosto",
    ),
    "addTrustedContact": MessageLookupByLibrary.simpleMessage(
      "Aggiungi contatto fidato",
    ),
    ...
    "after1Week": MessageLookupByLibrary.simpleMessage("Dopo una settimana"),
    ...
    "albumUpdated": MessageLookupByLibrary.simpleMessage("Album aggiornato"),
    ...
    "allowDownloads": MessageLookupByLibrary.simpleMessage("Consenti download"),
    ...
    "applyCodeTitle": MessageLookupByLibrary.simpleMessage("Applica codice"),
    "appstoreSubscription": MessageLookupByLibrary.simpleMessage(
      "abbonamento AppStore",
    ),
    ...
    "authenticating": MessageLookupByLibrary.simpleMessage("Autenticazione..."),
    ...
    "autoPair": MessageLookupByLibrary.simpleMessage("Associazione automatica"),
    ...
    "backedUpFolders": MessageLookupByLibrary.simpleMessage("Cartelle salvate"),
    ...
    "backupVideos": MessageLookupByLibrary.simpleMessage("Backup dei video"),
    ...
    "checking": MessageLookupByLibrary.simpleMessage("Controllo in corso..."),
    ...
    "collectPhotos": MessageLookupByLibrary.simpleMessage("Raccogli le foto"),
    ...
    "continueOnFreeTrial": MessageLookupByLibrary.simpleMessage(
      "Continua la prova gratuita",
    ),
    "convertToAlbum": MessageLookupByLibrary.simpleMessage("Converti in album"),
    ...
    "createCollaborativeLink": MessageLookupByLibrary.simpleMessage(
      "Crea link collaborativo",
    ),
    "createCollage": MessageLookupByLibrary.simpleMessage("Crea un collage"),
    "createNewAccount": MessageLookupByLibrary.simpleMessage(
      "Crea un nuovo account",
    ),
    "createOrSelectAlbum": MessageLookupByLibrary.simpleMessage(
      "Crea o seleziona album",
    ),
    "createPublicLink": MessageLookupByLibrary.simpleMessage(
      "Crea link pubblico",
    ),
    "creatingLink": MessageLookupByLibrary.simpleMessage("Creazione link..."),
    ...
    "deduplicateFiles": MessageLookupByLibrary.simpleMessage("File Duplicati"),
    ...
    "deleteFromEnte": MessageLookupByLibrary.simpleMessage("Elimina da Ente"),
    "deleteItemCount": m22,
    "deleteLocation": MessageLookupByLibrary.simpleMessage("Elimina posizione"),
    ...
    "deselectAll": MessageLookupByLibrary.simpleMessage("Deseleziona tutti"),
    ...
    "discover_greenery": MessageLookupByLibrary.simpleMessage("Vegetazione"),
    ...
    "discover_pets": MessageLookupByLibrary.simpleMessage("Animali domestici"),
    "discover_receipts": MessageLookupByLibrary.simpleMessage("Ricette"),
    "discover_screenshots": MessageLookupByLibrary.simpleMessage("Schermate"),
    ...
    "failedToRenew": MessageLookupByLibrary.simpleMessage("Rinnovo fallito"),
    ...
    "familyPlanPortalTitle": MessageLookupByLibrary.simpleMessage("Famiglia"),
    ...
    "hideContent": MessageLookupByLibrary.simpleMessage(
    ...
    "incorrectCode": MessageLookupByLibrary.simpleMessage("Codice sbagliato"),
    ...
    "joinAlbum": MessageLookupByLibrary.simpleMessage("Unisciti all\'album"),
    ...
    "joinDiscord": MessageLookupByLibrary.simpleMessage("Unisciti a Discord"),
    ...
    "lastUpdated": MessageLookupByLibrary.simpleMessage("Ultimo aggiornamento"),
    "lastYearsTrip": MessageLookupByLibrary.simpleMessage(
      "Viaggio dello scorso anno",
    ),
    "leave": MessageLookupByLibrary.simpleMessage("Lascia"),
    "leaveAlbum": MessageLookupByLibrary.simpleMessage("Abbandona l\'album"),
    "leaveFamily": MessageLookupByLibrary.simpleMessage(
      "Abbandona il piano famiglia",
    ),
    ...
    "legacyAccounts": MessageLookupByLibrary.simpleMessage("Account Legacy"),
    "legacyInvite": m47,
    ...
    "linkHasExpired": MessageLookupByLibrary.simpleMessage("Il link è scaduto"),
    ...
    "locationName": MessageLookupByLibrary.simpleMessage("Nome della località"),
    ...
    "lockscreen": MessageLookupByLibrary.simpleMessage("Schermata di blocco"),
    ...
    "loopVideoOff": MessageLookupByLibrary.simpleMessage(
      "Loop video disattivo",
    ),
    "loopVideoOn": MessageLookupByLibrary.simpleMessage("Loop video attivo"),
    "lostDevice": MessageLookupByLibrary.simpleMessage("Dispositivo perso?"),
    ...
    "mergedPhotos": MessageLookupByLibrary.simpleMessage("Fotografie unite"),
    ...
    "moveToAlbum": MessageLookupByLibrary.simpleMessage("Sposta nell\'album"),
    "moveToHiddenAlbum": MessageLookupByLibrary.simpleMessage(
      "Sposta in album nascosto",
    ),
    ...
    "newToEnte": MessageLookupByLibrary.simpleMessage("Prima volta con Ente"),
    ...
    "noDuplicates": MessageLookupByLibrary.simpleMessage("✨ Nessun doppione"),
    ...
    "passkeyAuthTitle": MessageLookupByLibrary.simpleMessage(
      "Verifica della passkey",
    ),
    "password": MessageLookupByLibrary.simpleMessage("Password"),
    "passwordChangedSuccessfully": MessageLookupByLibrary.simpleMessage(
      "Password modificata con successo",
    ),
    "passwordLock": MessageLookupByLibrary.simpleMessage("Blocco con password"),
    ...
    "pendingItems": MessageLookupByLibrary.simpleMessage("Elementi in sospeso"),
    ...
    "personIsAge": m60,
    "personName": MessageLookupByLibrary.simpleMessage("Nome della persona"),
    ...
    "playOnTv": MessageLookupByLibrary.simpleMessage(
      "Riproduci album sulla TV",
    ),
    "playOriginal": MessageLookupByLibrary.simpleMessage("Riproduci originale"),
    "playStoreFreeTrialValidTill": m64,
    "playStream": MessageLookupByLibrary.simpleMessage(
      "Riproduci lo streaming",
    ),
    "playstoreSubscription": MessageLookupByLibrary.simpleMessage(
      "Abbonamento su PlayStore",
    ),
    ...
    "privateBackups": MessageLookupByLibrary.simpleMessage("Backup privato"),
    ...
    "publicLinkCreated": MessageLookupByLibrary.simpleMessage(
      "Link pubblico creato",
    ),
    "publicLinkEnabled": MessageLookupByLibrary.simpleMessage(
      "Link pubblico abilitato",
    ),
    "queued": MessageLookupByLibrary.simpleMessage("In coda"),
    "quickLinks": MessageLookupByLibrary.simpleMessage("Collegamenti rapidi"),
    ...
    "recoverAccount": MessageLookupByLibrary.simpleMessage("Recupera account"),
    ...
    "recoveryKey": MessageLookupByLibrary.simpleMessage("Chiave di recupero"),
    ...
    "reenterPin": MessageLookupByLibrary.simpleMessage("Reinserisci il PIN"),
    ...
    "searchByAlbumNameHint": MessageLookupByLibrary.simpleMessage("Nome album"),
    ...
    "selectReason": MessageLookupByLibrary.simpleMessage("Seleziona un motivo"),
    ...
    "setNewPin": MessageLookupByLibrary.simpleMessage("Imposta un nuovo PIN"),
    ...
    "sharedPhotoNotifications": MessageLookupByLibrary.simpleMessage(
      "Nuove foto condivise",
    ),
    "sharedPhotoNotificationsExplanation": MessageLookupByLibrary.simpleMessage(
      "Ricevi notifiche quando qualcuno aggiunge una foto a un album condiviso, di cui fai parte",
    ),
    "sharedWith": m88,
    "sharedWithMe": MessageLookupByLibrary.simpleMessage("Condivisi con me"),
    "sharedWithYou": MessageLookupByLibrary.simpleMessage("Condivise con te"),
    "sharing": MessageLookupByLibrary.simpleMessage("Condivisione in corso..."),
    ...
    "sparkleSuccess": MessageLookupByLibrary.simpleMessage(
      "✨ Operazione riuscita",
    ),
    "sportsWithThem": m92,
    "spotlightOnThem": m93,
    ...
    "storage": MessageLookupByLibrary.simpleMessage("Spazio di archiviazione"),
    "storageBreakupFamily": MessageLookupByLibrary.simpleMessage("Famiglia"),
    ...
    "tapToUnlock": MessageLookupByLibrary.simpleMessage("Tocca per sbloccare"),
    "tapToUpload": MessageLookupByLibrary.simpleMessage("Premi per caricare"),
    ...
    "thisDevice": MessageLookupByLibrary.simpleMessage("Questo dispositivo"),
    ...
    "tripInYear": m105,
    "tripToLocation": m106,
    "trustedContacts": MessageLookupByLibrary.simpleMessage("Contatti fidati"),
    ...
    "unarchive": MessageLookupByLibrary.simpleMessage("Rimuovi dall\'archivio"),
    ...
    "upgrade": MessageLookupByLibrary.simpleMessage("Acquista altro spazio"),
    ...
    "useAsCover": MessageLookupByLibrary.simpleMessage("Usa come copertina"),
    ...
    "verificationId": MessageLookupByLibrary.simpleMessage("ID di verifica"),
    ...
    "verifyPasskey": MessageLookupByLibrary.simpleMessage("Verifica passkey"),
    "verifyPassword": MessageLookupByLibrary.simpleMessage("Verifica password"),
    "verifying": MessageLookupByLibrary.simpleMessage("Verifica in corso..."),
