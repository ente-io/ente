...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m7(count) =>
      "${Intl.plural(count, one: '已成功添加到 1 个相册', other: '已成功添加到 ${count} 个相册')}";

  static String m8(name) => "欣赏 ${name}";
  ...
  static String m12(name) => "与 ${name} 一起欣赏美景";

  static String m13(paymentProvider) => "请先取消您现有的订阅 ${paymentProvider}";

  static String m14(user) => "${user} 将无法添加更多照片到此相册\n\n他们仍然能够删除他们添加的现有照片";

  static String m15(isFamilyMember, storageAmountInGb) =>
      "${Intl.select(isFamilyMember, {'true': '到目前为止，您的家庭已经领取了 ${storageAmountInGb} GB', 'false': '到目前为止，您已经领取了 ${storageAmountInGb} GB', 'other': '到目前为止，您已经领取了${storageAmountInGb} GB'})}";

  static String m16(albumName) => "为 ${albumName} 创建了协作链接";
  ...
  static String m25(albumName) => "这将删除用于访问\"${albumName}\"的公开链接。";

  static String m26(supportEmail) => "请从您注册的邮箱发送一封邮件到 ${supportEmail}";
  ...
  static String m29(name) => "此电子邮件已与${name}关联。";

  static String m30(newEmail) => "电子邮件已更改为 ${newEmail}";

  static String m31(email) => "${email} 没有 Ente 账户。";

  static String m32(email) => "${email} 没有 Ente 帐户。\n\n向他们发出共享照片的邀请。";

  static String m33(name) => "拥抱 ${name}";

  static String m34(text) => "为 ${text} 找到额外照片";

  static String m35(name) => "与 ${name} 的盛宴";
  ...
  static String m41(sizeInMBorGB) => "释放 ${sizeInMBorGB}";
  ...
  static String m113(name) => "查看${name}以解除关联";
  ...
  static String m116(name) => "祝 ${name} 生日快乐！ 🎉";

  static String m117(count) =>
      "${Intl.plural(count, one: '${count} 年前', other: '${count} 年前')}";

  static String m118(name) => "您和 ${name}";

  static String m119(storageSaved) => "您已成功释放了 ${storageSaved}！";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "addPeopleWidgetPrompt": MessageLookupByLibrary.simpleMessage(
      "将人物小组件添加到您的主屏幕，然后返回此处进行自定义。",
    ),
    "addPhotos": MessageLookupByLibrary.simpleMessage("添加照片"),
    "addSelected": MessageLookupByLibrary.simpleMessage("添加所选项"),
    "addSomePhotosDesc1": MessageLookupByLibrary.simpleMessage("添加一些照片或者选择 "),
    "addSomePhotosDesc2": MessageLookupByLibrary.simpleMessage("熟悉的面孔"),
    "addSomePhotosDesc3": MessageLookupByLibrary.simpleMessage("首先"),
    ...
    "addedToAlbums": m7,
    "addingPhotos": MessageLookupByLibrary.simpleMessage("正在添加照片"),
    "addingToFavorites": MessageLookupByLibrary.simpleMessage("正在添加到收藏..."),
    "adjust": MessageLookupByLibrary.simpleMessage("调整"),
    "admiringThem": m8,
    ...
    "align": MessageLookupByLibrary.simpleMessage("对齐"),
    "allClear": MessageLookupByLibrary.simpleMessage("✨ 全部清除"),
    "allMemoriesPreserved": MessageLookupByLibrary.simpleMessage("所有回忆都已保存"),
    ...
    "allowPeopleToAddPhotos": MessageLookupByLibrary.simpleMessage("允许人们添加照片"),
    ...
    "appstoreSubscription": MessageLookupByLibrary.simpleMessage("AppStore 订阅"),
    ...
    "askCancelReason": MessageLookupByLibrary.simpleMessage("您的订阅已取消。您想分享原因吗？"),
    "askDeleteReason": MessageLookupByLibrary.simpleMessage("您删除账户的主要原因是什么？"),
    "askYourLovedOnesToShare": MessageLookupByLibrary.simpleMessage("请您的亲人分享"),
    ...
    "authToViewPasskey": MessageLookupByLibrary.simpleMessage("请验证身份以查看您的通行密钥"),
    ...
    "authenticationSuccessful": MessageLookupByLibrary.simpleMessage("验证成功"),
    "autoAddPeople": MessageLookupByLibrary.simpleMessage("自动添加人物"),
    "autoAddToAlbum": MessageLookupByLibrary.simpleMessage("自动添加到相册"),
    ...
    "backupOverMobileData": MessageLookupByLibrary.simpleMessage("通过移动数据备份"),
    ...
    "brushColor": MessageLookupByLibrary.simpleMessage("笔刷颜色"),
    "cLDesc1": MessageLookupByLibrary.simpleMessage(
      "我们正在发布一款全新且高级的图像编辑器，新增更多裁剪框架、快速编辑的滤镜预设，以及包括饱和度、对比度、亮度、色温等在内的精细调整选项。新的编辑器还支持在照片上绘制和添加表情符号作为贴纸。",
    ),
    "cLDesc2": MessageLookupByLibrary.simpleMessage(
      "您现在可以将所选人物的照片自动添加到任何相册。只需进入相册，从溢出菜单中选择“自动添加人物”。如果与共享相册一起使用，您可以零点击分享照片。",
    ),
    "cLDesc3": MessageLookupByLibrary.simpleMessage(
      "我们新增了按周、月、年对图库进行分组的功能。您现在可以通过这些新的分组选项以及自定义网格，定制图库的外观，完全按照您的喜好进行设置",
    ),
    "cLDesc4": MessageLookupByLibrary.simpleMessage(
      "除了多项后台改进以提升图库滚动体验外，我们还重新设计了滚动条，添加了标记功能，让您可以快速跳转到时间轴上的不同位置。",
    ),
    "cLTitle1": MessageLookupByLibrary.simpleMessage("高级图像编辑器"),
    "cLTitle2": MessageLookupByLibrary.simpleMessage("智能相册"),
    "cLTitle3": MessageLookupByLibrary.simpleMessage("改进的相册"),
    "cLTitle4": MessageLookupByLibrary.simpleMessage("更快滚动"),
    "cachedData": MessageLookupByLibrary.simpleMessage("缓存数据"),
    "calculating": MessageLookupByLibrary.simpleMessage("正在计算..."),
    "canNotOpenBody": MessageLookupByLibrary.simpleMessage("抱歉，该相册无法在应用中打开。"),
    ...
    "cannotDeleteSharedFiles": MessageLookupByLibrary.simpleMessage("无法删除共享文件"),
    ...
    "changeYourReferralCode": MessageLookupByLibrary.simpleMessage("更改您的推荐代码"),
    ...
    "clickOnTheOverflowMenu": MessageLookupByLibrary.simpleMessage("• 点击溢出菜单"),
    ...
    "codeCopiedToClipboard": MessageLookupByLibrary.simpleMessage("代码已复制到剪贴板"),
    ...
    "confirmYourRecoveryKey": MessageLookupByLibrary.simpleMessage("确认您的恢复密钥"),
    ...
    "createCollaborativeLink": MessageLookupByLibrary.simpleMessage("创建协作链接"),
    ...
    "criticalUpdateAvailable": MessageLookupByLibrary.simpleMessage("可用的关键更新"),
    ...
    "disableDownloadWarningBody": MessageLookupByLibrary.simpleMessage(
      "查看者仍然可以使用外部工具截图或保存您的照片副本",
    ),
    "disableDownloadWarningTitle": MessageLookupByLibrary.simpleMessage("请注意"),
    ...
    "emailNotRegistered": MessageLookupByLibrary.simpleMessage("此电子邮件地址未被注册。"),
    "emailVerificationToggle": MessageLookupByLibrary.simpleMessage("电子邮件验证"),
    ...
    "endpointUpdatedMessage": MessageLookupByLibrary.simpleMessage("端点更新成功"),
    ...
    "enterValidEmail": MessageLookupByLibrary.simpleMessage("请输入一个有效的电子邮件地址。"),
    ...
    "enterYourRecoveryKey": MessageLookupByLibrary.simpleMessage("输入您的恢复密钥"),
    ...
    "faceNotClusteredYet": MessageLookupByLibrary.simpleMessage("人脸尚未聚类，请稍后再来"),
    ...
    "filesSavedToGallery": MessageLookupByLibrary.simpleMessage("多个文件已保存到相册"),
    ...
    "genericProgress": m43,
    "gettingReady": MessageLookupByLibrary.simpleMessage("准备就绪"),
    ...
    "groupBy": MessageLookupByLibrary.simpleMessage("分组依据"),
    ...
    "incorrectRecoveryKey": MessageLookupByLibrary.simpleMessage("不正确的恢复密钥"),
    ...
    "invalidEmailAddress": MessageLookupByLibrary.simpleMessage("无效的电子邮件地址"),
    "invalidEndpoint": MessageLookupByLibrary.simpleMessage("端点无效"),
    "invalidEndpointMessage": MessageLookupByLibrary.simpleMessage(
      "抱歉，您输入的端点无效。请输入有效的端点，然后重试。",
    ),
    ...
    "linkCopiedToClipboard": MessageLookupByLibrary.simpleMessage("链接已复制到剪贴板"),
    ...
    "loadMessage3": MessageLookupByLibrary.simpleMessage(
      "我们保存你的3个数据副本，其中一个在地下安全屋中",
    ),
    "loadMessage4": MessageLookupByLibrary.simpleMessage("我们所有的应用程序都是开源的"),
    "loadMessage5": MessageLookupByLibrary.simpleMessage("我们的源代码和加密技术已经由外部审计"),
    "loadMessage6": MessageLookupByLibrary.simpleMessage("您可以与您所爱的人分享您相册的链接"),
    "loadMessage7": MessageLookupByLibrary.simpleMessage(
      "我们的移动应用程序在后台运行以加密和备份您点击的任何新照片",
    ),
    "loadMessage8": MessageLookupByLibrary.simpleMessage(
      "web.ente.io 有一个巧妙的上传器",
    ),
    "loadMessage9": MessageLookupByLibrary.simpleMessage(
      "我们使用 Xchacha20Poly1305 加密技术来安全地加密您的数据",
    ),
    "loadingExifData": MessageLookupByLibrary.simpleMessage("正在加载 EXIF 数据..."),
    ...
    "loadingYourPhotos": MessageLookupByLibrary.simpleMessage("正在加载您的照片..."),
    ...
    "lookBackOnYourMemories": MessageLookupByLibrary.simpleMessage("回顾你的回忆🌄"),
    ...
    "mixedGrouping": MessageLookupByLibrary.simpleMessage("混合分组？"),
    ...
    "mobileWebDesktop": MessageLookupByLibrary.simpleMessage("移动端, 网页端, 桌面端"),
    ...
    "movingFilesToAlbum": MessageLookupByLibrary.simpleMessage("正在将文件移动到相册..."),
    ...
    "noAlbumsSharedByYouYet": MessageLookupByLibrary.simpleMessage("您尚未共享任何相册"),
    ...
    "noImagesWithLocation": MessageLookupByLibrary.simpleMessage("没有带有位置的图像"),
    ...
    "oopsCouldNotSaveEdits": MessageLookupByLibrary.simpleMessage("糟糕，无法保存编辑"),
    ...
    "orPickAnExistingOne": MessageLookupByLibrary.simpleMessage("或者选择一个现有的"),
    ...
    "peopleAutoAddDesc": MessageLookupByLibrary.simpleMessage("选择您想要自动添加到相册的人"),
    "peopleUsingYourCode": MessageLookupByLibrary.simpleMessage("使用您的代码的人"),
    "peopleWidgetDesc": MessageLookupByLibrary.simpleMessage("选择您希望在主屏幕上看到的人。"),
    ...
    "pressAndHoldToPlayVideo": MessageLookupByLibrary.simpleMessage("按住以播放视频"),
    ...
    "removeFromAlbumTitle": MessageLookupByLibrary.simpleMessage("要从相册中移除吗？"),
    ...
    "selectALocationFirst": MessageLookupByLibrary.simpleMessage("首先选择一个位置"),
    ...
    "selectFoldersForBackup": MessageLookupByLibrary.simpleMessage("选择要备份的文件夹"),
    ...
    "selectOneDateAndTime": MessageLookupByLibrary.simpleMessage("选择一个日期和时间"),
    ...
    "shareYourFirstAlbum": MessageLookupByLibrary.simpleMessage("分享您的第一个相册"),
    ...
    "sharedPhotoNotifications": MessageLookupByLibrary.simpleMessage("新共享的照片"),
    "sharedPhotoNotificationsExplanation": MessageLookupByLibrary.simpleMessage(
      "当有人将照片添加到您所属的共享相册时收到通知",
    ),
    "sharedWith": m88,
    ...
    "startAccountRecoveryTitle": MessageLookupByLibrary.simpleMessage("开始恢复"),
    ...
    "successfullyUnarchived": MessageLookupByLibrary.simpleMessage("取消存档成功"),
    ...
    "thankYouForSubscribing": MessageLookupByLibrary.simpleMessage("感谢您的订阅！"),
    ...
    "thisActionCannotBeUndone": MessageLookupByLibrary.simpleMessage("此操作无法撤销"),
    ...
    "unhidingFilesToAlbum": MessageLookupByLibrary.simpleMessage("正在取消隐藏文件到相册"),
    ...
    "verifyingRecoveryKey": MessageLookupByLibrary.simpleMessage("正在验证恢复密钥..."),
    ...
    "visitWebToManage": MessageLookupByLibrary.simpleMessage(
      "请访问 web.ente.io 来管理您的订阅",
    ),
    "waitingForVerification": MessageLookupByLibrary.simpleMessage("等待验证..."),
    ...
    "youAndThem": m118,
    "youAreOnAFamilyPlan": MessageLookupByLibrary.simpleMessage("你在一个家庭计划中！"),
    "youAreOnTheLatestVersion": MessageLookupByLibrary.simpleMessage("当前为最新版本"),
    ...
    "yourPurchaseWasSuccessful": MessageLookupByLibrary.simpleMessage("您购买成功！"),
