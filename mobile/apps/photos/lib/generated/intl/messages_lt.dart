...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m8(name) => "Žavisi ${name}";
  ...
  static String m12(name) => "Gražūs vaizdai su ${name}";
  ...
  static String m15(isFamilyMember, storageAmountInGb) =>
      "${Intl.select(isFamilyMember, {'true': 'Jūsų šeima gavo ${storageAmountInGb} GB iki šiol', 'false': 'Jūs gavote ${storageAmountInGb} GB iki šiol', 'other': 'Jūs gavote ${storageAmountInGb} GB iki šiol.'})}";
  ...
  static String m29(name) => "Šis el. paštas jau susietas su ${name}.";

  static String m30(newEmail) => "El. paštas pakeistas į ${newEmail}";

  static String m31(email) => "${email} neturi „Ente“ paskyros.";

  static String m32(email) =>
      "${email} neturi „Ente“ paskyros.\n\nSiųskite jiems kvietimą bendrinti nuotraukas.";

  static String m33(name) => "Apkabinat ${name}";

  static String m34(text) => "Rastos papildomos nuotraukos, skirtos ${text}";

  static String m35(name) => "Vaišiavimas su ${name}";
  ...
  static String m41(sizeInMBorGB) => "Atlaisvinti ${sizeInMBorGB}";
  ...
  static String m44(name) => "Žygiavimas su ${name}";

  static String m45(count) =>
      "${Intl.plural(count, one: '${count} elementas', other: '${count} elementų')}";

  static String m46(name) => "Paskutinį kartą su ${name}";

  static String m47(email) => "${email} pakvietė jus būti patikimu kontaktu";

  static String m48(expiryTime) => "Nuoroda nebegalios ${expiryTime}";

  static String m49(email) => "Susieti asmenį su ${email}";
  ...
  static String m53(albumName) => "Sėkmingai perkelta į „${albumName}“";

  static String m54(personName) => "Nėra pasiūlymų asmeniui ${personName}.";

  static String m55(name) => "Ne ${name}?";

  static String m56(familyAdminEmail) =>
      "Susisiekite su ${familyAdminEmail}, kad pakeistumėte savo kodą.";

  static String m57(name) => "Vakarėlis su ${name}";
  ...
  static String m60(name, age) => "${name} yra ${age} m.!";

  static String m61(name, age) => "${name} netrukus sulauks ${age} m.";
  ...
  static String m65(toEmail) => "Siųskite el. laišką mums adresu ${toEmail}.";

  static String m66(toEmail) => "Siųskite žurnalus adresu\n${toEmail}";

  static String m67(name) => "Pozavimas su ${name}";

  static String m68(folderName) => "Apdorojama ${folderName}...";

  static String m69(storeName) => "Vertinti mus parduotuvėje „${storeName}“";

  static String m70(name) => "Perskirstė jus į ${name}";
  ...
  static String m73(email) => "${email} bando atkurti jūsų paskyrą.";
  ...
  static String m76(endDate) => "Prenumerata pratęsiama ${endDate}";

  static String m77(name) => "Kelionė su ${name}";
  ...
  static String m81(count) => "${count} pasirinkta";

  static String m82(count, yourCount) =>
      "${count} pasirinkta (${yourCount} jūsų)";

  static String m83(name) => "Asmenukės su ${name}";
  ...
  static String m88(emailIDs) => "Bendrinta su ${emailIDs}";
  ...
  static String m91(fileType) => "Šis ${fileType} bus ištrintas iš „Ente“.";

  static String m92(name) => "Sportai su ${name}";

  static String m93(name) => "Dėmesys ${name}";
  ...
  static String m97(endDate) => "Jūsų prenumerata bus atsisakyta ${endDate}";
  ...
  static String m110(count) => "Išsaugomi ${count} prisiminimai...";

  static String m111(endDate) => "Galioja iki ${endDate}";

  static String m112(email) => "Patvirtinti ${email}";

  static String m113(name) => "Peržiūrėkite ${name}, kad atsietumėte";
  ...
  static String m116(name) => "Palinkėkite ${name} su gimtadieniu! 🎉";

  static String m117(count) =>
      "${Intl.plural(count, one: 'prieš ${count} metus', other: 'prieš ${count} metų')}";

  static String m118(name) => "Jūs ir ${name}";

  static String m119(storageSaved) => "Sėkmingai atlaisvinote ${storageSaved}!";

  final messages = _notInlinedMessages(_notInlinedMessages);
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    "aNewVersionOfEnteIsAvailable": MessageLookupByLibrary.simpleMessage(
      "Yra nauja „Ente“ versija.",
    ),
    ...
    "addParticipants": MessageLookupByLibrary.simpleMessage("Įtraukti dalyvių"),
    ...
    "addSelected": MessageLookupByLibrary.simpleMessage("Pridėti pasirinktus"),
    ...
    "addingPhotos": MessageLookupByLibrary.simpleMessage(
      "Įtraukiamos nuotraukos",
    ),
    "addingToFavorites": MessageLookupByLibrary.simpleMessage(
      "Pridedama prie mėgstamų...",
    ),
    "adjust": MessageLookupByLibrary.simpleMessage("Priderinti"),
    "admiringThem": m8,
    "advanced": MessageLookupByLibrary.simpleMessage("Išplėstiniai"),
    "advancedSettings": MessageLookupByLibrary.simpleMessage("Išplėstiniai"),
    ...
    "albumTitle": MessageLookupByLibrary.simpleMessage("Albumo pavadinimas"),
    "albumUpdated": MessageLookupByLibrary.simpleMessage("Atnaujintas albumas"),
    ...
    "align": MessageLookupByLibrary.simpleMessage("Lygiuoti"),
    "allClear": MessageLookupByLibrary.simpleMessage("✨ Viskas išvalyta"),
    "allMemoriesPreserved": MessageLookupByLibrary.simpleMessage(
      "Išsaugoti visi prisiminimai",
    ),
    ...
    "analysis": MessageLookupByLibrary.simpleMessage("Analizė"),
    ...
    "androidBiometricRequiredTitle": MessageLookupByLibrary.simpleMessage(
      "Privaloma biometrija",
    ),
    "androidBiometricSuccess": MessageLookupByLibrary.simpleMessage("Sėkmė"),
    ...
    "appstoreSubscription": MessageLookupByLibrary.simpleMessage(
      "„App Store“ prenumerata",
    ),
    "archive": MessageLookupByLibrary.simpleMessage("Archyvas"),
    "archiveAlbum": MessageLookupByLibrary.simpleMessage("Archyvuoti albumą"),
    ...
    "autoAddPeople": MessageLookupByLibrary.simpleMessage(
      "Automatiškai įtraukti asmenis",
    ),
    "autoAddToAlbum": MessageLookupByLibrary.simpleMessage(
      "Automatiškai įtraukti į albumą",
    ),
    ...
    "autoLock": MessageLookupByLibrary.simpleMessage("Automatinis užraktas"),
    ...
    "autoPair": MessageLookupByLibrary.simpleMessage("Automatiškai susieti"),
    ...
    "background": MessageLookupByLibrary.simpleMessage("Fonas"),
    "backgroundWithThem": m12,
    "backup": MessageLookupByLibrary.simpleMessage("Kurti atsarginę kopiją"),
    ...
    "brushColor": MessageLookupByLibrary.simpleMessage("Teptuko spalva"),
    "cLDesc1": MessageLookupByLibrary.simpleMessage(
      "Mes išleidžiame naują ir pažangią vaizdų rengyklę, kurioje yra daugiau apkirpimo rėmelių, filtro nustatymų sparčiams redagavimams, tikslaus sureguliavimo parinkčių, įskaitant sodrumą, kontrastą, skaistį, temperatūrą ir daug daugiau. Naujoji rengyklė taip pat suteikia galimybę piešti ant nuotraukų ir pridėti jaustukus kaip lipdukus.",
    ),
    "cLDesc2": MessageLookupByLibrary.simpleMessage(
      "Dabar galite automatiškai įtraukti pasirinktų asmenų nuotraukas į bet kurį albumą. Tiesiog eikite į albumą ir iš išskleidžiamojo meniu pasirinkite „Automatiškai įtraukti asmenis“. Jei naudojama kartu su bendrinimu albumu, nuotraukas galite bendrinti be jokių paspaudimų.",
    ),
    "cLDesc3": MessageLookupByLibrary.simpleMessage(
      "Pridėjome galimybę sugrupuoti galeriją pagal savaites, mėnesius ir metus. Dabar galite pritaikyti galeriją taip, kad ji atrodytų būtent taip, kaip norite su šiomis naujomis grupavimo parinktimis ir pasirinktiniais tinkleliais.",
    ),
    "cLDesc4": MessageLookupByLibrary.simpleMessage(
      "Kartu su daugybe vidinių patobulinimų pagerinti galerijos slinkimo patirtį, mes taip pat pertvarkėme slinkties juostą, kad joje būtų rodomi žymekliai, leidžiantys sparčiai pereiti per laiko juostą.",
    ),
    "cLTitle1": MessageLookupByLibrary.simpleMessage("Pažangi vaizdų rengyklė"),
    "cLTitle2": MessageLookupByLibrary.simpleMessage("Išmanieji albumai"),
    "cLTitle3": MessageLookupByLibrary.simpleMessage("Patobulinta galerija"),
    "cLTitle4": MessageLookupByLibrary.simpleMessage("Spartesnis slinkimas"),
    "cachedData": MessageLookupByLibrary.simpleMessage("Podėliuoti duomenis"),
    ...
    "clearIndexes": MessageLookupByLibrary.simpleMessage("Valyti indeksavimus"),
    ...
    "collectEventPhotos": MessageLookupByLibrary.simpleMessage(
      "Rinkti įvykių nuotraukas",
    ),
    "collectPhotos": MessageLookupByLibrary.simpleMessage("Rinkti nuotraukas"),
    ...
    "deleteFromDevice": MessageLookupByLibrary.simpleMessage(
      "Ištrinti iš įrenginio",
    ),
    "deleteFromEnte": MessageLookupByLibrary.simpleMessage(
      "Ištrinti iš „Ente“",
    ),
    "deleteItemCount": m22,
    "deleteLocation": MessageLookupByLibrary.simpleMessage("Ištrinti vietovę"),
    "deleteMultipleAlbumDialog": m23,
    "deletePhotos": MessageLookupByLibrary.simpleMessage("Ištrinti nuotraukas"),
    "deleteProgress": m24,
    ...
    "deselectAll": MessageLookupByLibrary.simpleMessage(
      "Naikinti visų pasirinkimą",
    ),
    ...
    "deviceLock": MessageLookupByLibrary.simpleMessage("Įrenginio užraktas"),
    ...
    "discover_celebrations": MessageLookupByLibrary.simpleMessage("Šventės"),
    ...
    "discover_wallpapers": MessageLookupByLibrary.simpleMessage("Ekrano fonai"),
    ...
    "doThisLater": MessageLookupByLibrary.simpleMessage("Daryti tai vėliau"),
    ...
    "draw": MessageLookupByLibrary.simpleMessage("Piešti"),
    ...
    "editAutoAddPeople": MessageLookupByLibrary.simpleMessage(
      "Redaguoti automatiškai įtrauktus asmenis",
    ),
    "editEmailAlreadyLinked": m29,
    "editLocation": MessageLookupByLibrary.simpleMessage("Redaguoti vietovę"),
    ...
    "editsSaved": MessageLookupByLibrary.simpleMessage("Redagavimai išsaugoti"),
    ...
    "emptyTrash": MessageLookupByLibrary.simpleMessage("Ištuštinti šiukšlinę?"),
    ...
    "enableMaps": MessageLookupByLibrary.simpleMessage("Įjungti žemėlapius"),
    ...
    "encryptionKeys": MessageLookupByLibrary.simpleMessage("Šifravimo raktai"),
    ...
    "enterDateOfBirth": MessageLookupByLibrary.simpleMessage(
      "Gimtadienis (neprivaloma)",
    ),
    "enterEmail": MessageLookupByLibrary.simpleMessage("Įveskite el. paštą"),
    ...
    "existingUser": MessageLookupByLibrary.simpleMessage("Esamas naudotojas"),
    "expiredLinkInfo": MessageLookupByLibrary.simpleMessage(
      "Ši nuoroda nebegalioja. Pasirinkite naują galiojimo laiką arba išjunkite nuorodos galiojimo laiką.",
    ),
    "exportLogs": MessageLookupByLibrary.simpleMessage("Eksportuoti žurnalus"),
    ...
    "failedToRenew": MessageLookupByLibrary.simpleMessage("Nepavyko pratęsti."),
    ...
    "filesSavedToGallery": MessageLookupByLibrary.simpleMessage(
      "Failai išsaugoti į galeriją",
    ),
    "filter": MessageLookupByLibrary.simpleMessage("Filtruoti"),
    "findPeopleByName": MessageLookupByLibrary.simpleMessage(
      "Sparčiai suraskite asmenis pagal vardą",
    ),
    "findThemQuickly": MessageLookupByLibrary.simpleMessage(
      "Raskite juos sparčiai",
    ),
    "flip": MessageLookupByLibrary.simpleMessage("Apversti"),
    "font": MessageLookupByLibrary.simpleMessage("Šriftas"),
    ...
    "freeStorageClaimed": MessageLookupByLibrary.simpleMessage(
      "Gauta nemokama saugykla",
    ),
    "freeStorageOnReferralSuccess": m38,
    "freeStorageUsable": MessageLookupByLibrary.simpleMessage(
      "Naudojama nemokama saugykla",
    ),
    ...
    "genericProgress": m43,
    "gettingReady": MessageLookupByLibrary.simpleMessage("Pasirengiama"),
    "goToSettings": MessageLookupByLibrary.simpleMessage("Eiti į nustatymus"),
    "googlePlayId": MessageLookupByLibrary.simpleMessage("„Google Play“ ID"),
    "grantFullAccessPrompt": MessageLookupByLibrary.simpleMessage(
      "Leiskite prieigą prie visų nuotraukų nustatymų programoje.",
    ),
    "grantPermission": MessageLookupByLibrary.simpleMessage("Suteikti leidimą"),
    ...
    "happyBirthday": MessageLookupByLibrary.simpleMessage("Su gimtadieniu! 🥳"),
    ...
    "ignorePerson": MessageLookupByLibrary.simpleMessage("Ignoruoti asmenį"),
    ...
    "inviteToEnte": MessageLookupByLibrary.simpleMessage("Kviesti į „Ente“"),
    "inviteYourFriends": MessageLookupByLibrary.simpleMessage(
      "Kviesti savo draugus",
    ),
    ...
    "joinAlbum": MessageLookupByLibrary.simpleMessage("Junkitės prie albumo"),
    ...
    "joinDiscord": MessageLookupByLibrary.simpleMessage(
      "Jungtis prie „Discord“",
    ),
    "keepPhotos": MessageLookupByLibrary.simpleMessage("Palikti nuotraukas"),
    ...
    "lastUpdated": MessageLookupByLibrary.simpleMessage(
      "Paskutinį kartą atnaujintą",
    ),
    "lastWeek": MessageLookupByLibrary.simpleMessage("Praėjusią savaitę"),
    "lastYearsTrip": MessageLookupByLibrary.simpleMessage(
      "Pastarųjų metų kelionė",
    ),
    "layout": MessageLookupByLibrary.simpleMessage("Išdėstymas"),
    ...
    "linkDeviceLimit": MessageLookupByLibrary.simpleMessage("Įrenginių riba"),
    ...
    "localGallery": MessageLookupByLibrary.simpleMessage("Vietinė galerija"),
    "localIndexing": MessageLookupByLibrary.simpleMessage(
      "Vietinis indeksavimas",
    ),
    ...
    "lostDevice": MessageLookupByLibrary.simpleMessage("Prarastas įrenginys?"),
    ...
    "mergedPhotos": MessageLookupByLibrary.simpleMessage(
      "Sujungtos nuotraukos",
    ),
    "mixedGrouping": MessageLookupByLibrary.simpleMessage(
      "Sumaišytas grupavimas?",
    ),
    "mlConsent": MessageLookupByLibrary.simpleMessage(
      "Įjungti mašininį mokymąsi",
    ),
    ...
    "moveToAlbum": MessageLookupByLibrary.simpleMessage("Perkelti į albumą"),
    "moveToHiddenAlbum": MessageLookupByLibrary.simpleMessage(
      "Perkelti į paslėptą albumą",
    ),
    "movedSuccessfullyTo": m53,
    "movedToTrash": MessageLookupByLibrary.simpleMessage(
      "Perkelta į šiukšlinę",
    ),
    "movingFilesToAlbum": MessageLookupByLibrary.simpleMessage(
      "Perkeliami failai į albumą...",
    ),
    "name": MessageLookupByLibrary.simpleMessage("Pavadinimą"),
    "nameTheAlbum": MessageLookupByLibrary.simpleMessage("Pavadinkite albumą"),
    ...
    "newToEnte": MessageLookupByLibrary.simpleMessage(
      "Naujas platformoje „Ente“",
    ),
    ...
    "noDeviceFound": MessageLookupByLibrary.simpleMessage("Įrenginys nerastas"),
    ...
    "noDuplicates": MessageLookupByLibrary.simpleMessage("✨ Dublikatų nėra"),
    ...
    "openSettings": MessageLookupByLibrary.simpleMessage("Atverti nustatymus"),
    ...
    "orMergeWithExistingPerson": MessageLookupByLibrary.simpleMessage(
      "Arba sujunkite su esamais",
    ),
    "orPickAnExistingOne": MessageLookupByLibrary.simpleMessage(
      "Arba pasirinkite esamą",
    ),
    ...
    "paymentDetails": MessageLookupByLibrary.simpleMessage("Mokėjimo duomenys"),
    ...
    "pendingItems": MessageLookupByLibrary.simpleMessage("Laukiami elementai"),
    "pendingSync": MessageLookupByLibrary.simpleMessage(
      "Laukiama sinchronizacija",
    ),
    "people": MessageLookupByLibrary.simpleMessage("Asmenys"),
    "peopleAutoAddDesc": MessageLookupByLibrary.simpleMessage(
      "Pasirinkite asmenis, kuriuos norite automatiškai įtraukti į albumą.",
    ),
    ...
    "preserveMore": MessageLookupByLibrary.simpleMessage("Išsaugoti daugiau"),
    ...
    "recoverAccount": MessageLookupByLibrary.simpleMessage("Atkurti paskyrą"),
    "recoverButton": MessageLookupByLibrary.simpleMessage("Atkurti"),
    "recoveryAccount": MessageLookupByLibrary.simpleMessage("Atkurti paskyrą"),
    ...
    "recreatePasswordTitle": MessageLookupByLibrary.simpleMessage(
      "Iš naujo sukurti slaptažodį",
    ),
    "reddit": MessageLookupByLibrary.simpleMessage("„Reddit“"),
    "redo": MessageLookupByLibrary.simpleMessage("Grąžinti"),
    "reenterPassword": MessageLookupByLibrary.simpleMessage(
      "Įveskite slaptažodį iš naujo",
    ),
    "reenterPin": MessageLookupByLibrary.simpleMessage("Įveskite PIN iš naujo"),
    ...
    "rejectRecovery": MessageLookupByLibrary.simpleMessage("Atmesti atkūrimą"),
    ...
    "remoteImages": MessageLookupByLibrary.simpleMessage("Nuotoliniai vaizdai"),
    "remoteThumbnails": MessageLookupByLibrary.simpleMessage(
      "Nuotolinės miniatiūros",
    ),
    "remoteVideos": MessageLookupByLibrary.simpleMessage(
      "Nuotoliniai vaizdo įrašai",
    ),
    ...
    "removeInvite": MessageLookupByLibrary.simpleMessage("Šalinti kvietimą"),
    "removeLink": MessageLookupByLibrary.simpleMessage("Šalinti nuorodą"),
    "removeParticipant": MessageLookupByLibrary.simpleMessage("Šalinti dalyvį"),
    ...
    "renewsOn": m76,
    "reportABug": MessageLookupByLibrary.simpleMessage("Pranešti apie riktą"),
    "reportBug": MessageLookupByLibrary.simpleMessage("Pranešti apie riktą"),
    ...
    "restoreToAlbum": MessageLookupByLibrary.simpleMessage("Atkurti į albumą"),
    ...
    "searchAlbumsEmptySection": MessageLookupByLibrary.simpleMessage("Albumai"),
    ...
    "searchHint1": MessageLookupByLibrary.simpleMessage(
      "Sparti paieška įrenginyje",
    ),
    "searchHint2": MessageLookupByLibrary.simpleMessage(
      "Nuotraukų datos ir aprašai",
    ),
    ...
    "selectAlbum": MessageLookupByLibrary.simpleMessage("Pasirinkti albumą"),
    ...
    "selectLanguage": MessageLookupByLibrary.simpleMessage("Pasirinkite kalbą"),
    "selectMailApp": MessageLookupByLibrary.simpleMessage(
      "Pasirinkti pašto programą",
    ),
    ...
    "selectYourFace": MessageLookupByLibrary.simpleMessage(
      "Pasirinkite savo veidą",
    ),
    "selectYourPlan": MessageLookupByLibrary.simpleMessage("Pasirinkite planą"),
    "selectedAlbums": m80,
    ...
    "serverEndpoint": MessageLookupByLibrary.simpleMessage(
      "Serverio galutinis taškas",
    ),
    "sessionExpired": MessageLookupByLibrary.simpleMessage("Seansas baigėsi"),
    ...
    "setNewPin": MessageLookupByLibrary.simpleMessage("Nustatykite naują PIN"),
    ...
    "shareALink": MessageLookupByLibrary.simpleMessage("Bendrinkite nuorodą"),
    ...
    "sharedByYou": MessageLookupByLibrary.simpleMessage("Bendrinta iš jūsų"),
    ...
    "sharedWith": m88,
    "sharedWithMe": MessageLookupByLibrary.simpleMessage("Bendrinta su manimi"),
    "sharedWithYou": MessageLookupByLibrary.simpleMessage("Bendrinta su jumis"),
    "sharing": MessageLookupByLibrary.simpleMessage("Bendrinima..."),
    "shiftDatesAndTime": MessageLookupByLibrary.simpleMessage(
      "Pastumti datas ir laiką",
    ),
    ...
    "showMemories": MessageLookupByLibrary.simpleMessage("Rodyti prisiminimus"),
    "showMoreFaces": MessageLookupByLibrary.simpleMessage(
      "Rodyti daugiau veidų",
    ),
    ...
    "sticker": MessageLookupByLibrary.simpleMessage("Lipdukas"),
    ...
    "terminateSession": MessageLookupByLibrary.simpleMessage("Baigti seansą?"),
    ...
    "todaysLogs": MessageLookupByLibrary.simpleMessage("Šiandienos žurnalai"),
    ...
    "unarchiving": MessageLookupByLibrary.simpleMessage("Išarchyvuojama..."),
    "unavailableReferralCode": MessageLookupByLibrary.simpleMessage(
      "Atsiprašome, šis kodas nepasiekiamas.",
    ),
    "uncategorized": MessageLookupByLibrary.simpleMessage("Nekategorizuoti"),
    "undo": MessageLookupByLibrary.simpleMessage("Anuliuoti"),
    "unhide": MessageLookupByLibrary.simpleMessage("Rodyti"),
    "unhideToAlbum": MessageLookupByLibrary.simpleMessage("Rodyti į albumą"),
    "unhiding": MessageLookupByLibrary.simpleMessage("Rodoma..."),
    "unhidingFilesToAlbum": MessageLookupByLibrary.simpleMessage(
      "Rodomi failai į albumą",
    ),
    ...
    "updateAvailable": MessageLookupByLibrary.simpleMessage("Yra naujinimas"),
    ...
    "useAsCover": MessageLookupByLibrary.simpleMessage("Naudoti kaip viršelį"),
    ...
    "verificationId": MessageLookupByLibrary.simpleMessage("Patvirtinimo ID"),
    ...
    "videoInfo": MessageLookupByLibrary.simpleMessage(
