...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m7(count) =>
      "${Intl.plural(count, one: 'Ajouté avec succès à 1 album', other: 'Ajouté avec succès à ${count} albums')}";

  static String m8(name) => "Admirant ${name}";
  ...
  static String m12(name) => "Magnifiques vues avec ${name}";
  ...
  static String m16(albumName) => "Lien collaboratif créé pour ${albumName}";
  ...
  static String m29(name) => "Cet e-mail est déjà lié à ${name}.";

  static String m30(newEmail) => "L\'email a été changé par ${newEmail}";

  static String m31(email) => "${email} n\'a pas de compte Ente.";

  static String m32(email) =>
      "${email} n\'a pas de compte Ente.\n\nEnvoyez une invitation pour partager des photos.";

  static String m33(name) => "Embrasse ${name}";

  static String m34(text) => "Photos supplémentaires trouvées pour ${text}";

  static String m35(name) => "Fête avec ${name}";
  ...
  static String m39(endDate) => "Essai gratuit valide jusqu’au ${endDate}";

  static String m40(count) =>
      "Vous pouvez toujours ${Intl.plural(count, one: 'l\'', other: 'les')} accéder sur Ente tant que vous avez un abonnement actif";

  static String m41(sizeInMBorGB) => "Libérer ${sizeInMBorGB}";
  ...
  static String m44(name) => "Randonnée avec ${name}";

  static String m45(count) =>
      "${Intl.plural(count, one: '${count} objet', other: '${count} objets')}";

  static String m46(name) => "Dernière fois avec ${name}";

  static String m47(email) =>
      "${email} vous a invité à être un contact de confiance";

  static String m48(expiryTime) => "Le lien expirera le ${expiryTime}";

  static String m49(email) => "Associer la personne à ${email}";
  ...
  static String m53(albumName) => "Déplacé avec succès vers ${albumName}";

  static String m54(personName) => "Aucune suggestion pour ${personName}";

  static String m55(name) => "Pas ${name}?";

  static String m56(familyAdminEmail) =>
      "Veuillez contacter ${familyAdminEmail} pour modifier votre code.";

  static String m57(name) => "En soirée avec ${name}";
  ...
  static String m60(name, age) => "${name} a ${age}!";

  static String m61(name, age) => "${name} aura bientôt ${age}";
  ...
  static String m65(toEmail) => "Merci de nous envoyer un email à ${toEmail}";

  static String m66(toEmail) => "Envoyez les logs à ${toEmail}";

  static String m67(name) => "Pose avec ${name}";

  static String m68(folderName) => "Traitement de ${folderName}...";

  static String m69(storeName) => "Laissez une note sur ${storeName}";

  static String m70(name) => "Vous a réassigné à ${name}";
  ...
  static String m73(email) => "${email} tente de récupérer votre compte.";
  ...
  static String m76(endDate) => "Renouvellement le ${endDate}";

  static String m77(name) => "En route avec ${name}";
  ...
  static String m81(count) => "${count} sélectionné(s)";

  static String m82(count, yourCount) =>
      "${count} sélectionné(s) (${yourCount} à vous)";

  static String m83(name) => "Selfies avec ${name}";
  ...
  static String m88(emailIDs) => "Partagé avec ${emailIDs}";
  ...
  static String m91(fileType) => "Cette ${fileType} sera supprimée de l\'Ente.";

  static String m92(name) => "Sports avec ${name}";

  static String m93(name) => "Spotlight sur ${name}";

  static String m94(storageAmountInGB) => "${storageAmountInGB} Go";
  ...
  static String m97(endDate) => "Votre abonnement sera annulé le ${endDate}";
  ...
  static String m101(email) => "Ceci est l\'ID de vérification de ${email}";
  ...
  static String m103(dateFormat) => "${dateFormat} au fil des années";

  static String m104(count) =>
      "${Intl.plural(count, zero: 'Bientôt', one: '1 jour', other: '${count} jours')}";

  static String m105(year) => "Voyage en ${year}";

  static String m106(location) => "Voyage vers ${location}";
  ...
  static String m110(count) => "Sauvegarde de ${count} souvenirs...";

  static String m111(endDate) => "Valable jusqu\'au ${endDate}";

  static String m112(email) => "Vérifier ${email}";

  static String m113(name) => "Voir ${name} pour délier";
  ...
  static String m116(name) => "Souhaitez à ${name} un joyeux anniversaire ! 🎉";

  static String m117(count) =>
      "${Intl.plural(count, one: 'il y a ${count} an', other: 'il y a ${count} ans')}";

  static String m118(name) => "Vous et ${name}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "addSomePhotosDesc1": MessageLookupByLibrary.simpleMessage(
      "Ajoutez quelques photos ou choisissez des ",
    ),
    ...
    "addedToAlbums": m7,
    "addingPhotos": MessageLookupByLibrary.simpleMessage("Ajout des photos"),
    "addingToFavorites": MessageLookupByLibrary.simpleMessage(
      "Ajout aux favoris...",
    ),
    "adjust": MessageLookupByLibrary.simpleMessage("Ajuster"),
    "admiringThem": m8,
    ...
    "align": MessageLookupByLibrary.simpleMessage("Aligner"),
    ...
    "areThey": MessageLookupByLibrary.simpleMessage("S\'agit-il de "),
    ...
    "autoAddPeople": MessageLookupByLibrary.simpleMessage(
      "Ajouter automatiquement des personnes",
    ),
    "autoAddToAlbum": MessageLookupByLibrary.simpleMessage(
      "Ajouter automatiquement à l\'album",
    ),
    ...
    "brushColor": MessageLookupByLibrary.simpleMessage("Couleur du pinceau"),
    "cLDesc1": MessageLookupByLibrary.simpleMessage(
      "Nous déployons un nouvel éditeur d\'image avancé qui ajoute plus d\'options de rognage, des filtres, des préréglages pour des modifications rapides ainsi que des options de réglage fin (la saturation, le contraste, la luminosité, la température et beaucoup plus). Le nouvel éditeur inclut également la possibilité de dessiner sur vos photos et d\'ajouter des emojis en tant qu\'autocollants.",
    ),
    "cLDesc2": MessageLookupByLibrary.simpleMessage(
      "Vous pouvez maintenant ajouter automatiquement des photos de personnes sélectionnées à n\'importe quel album. Allez simplement à l\'album et sélectionnez \"Ajouter automatiquement des personnes\" dans le menu déroulant. Couplé avec un album partagé, vous pouvez partager des photos en zéro clic.",
    ),
    "cLDesc3": MessageLookupByLibrary.simpleMessage(
      "Nous avons ajouté la possibilité de regrouper votre galerie par semaines, mois et années. Vous pouvez maintenant personnaliser votre galerie pour qu\'elle soit exactement comme vous le souhaitez avec ces nouvelles options de regroupement, ainsi que des grilles personnalisées",
    ),
    "cLDesc4": MessageLookupByLibrary.simpleMessage(
      "En plus des quelques améliorations pour améliorer l\'expérience de défilement de la galerie, nous avons également redessiné la barre de défilement pour afficher des marqueurs, ce qui vous permet de sauter rapidement dans la chronologie.",
    ),
    "cLTitle1": MessageLookupByLibrary.simpleMessage("Éditeur d\'image avancé"),
    ...
    "cLTitle4": MessageLookupByLibrary.simpleMessage("Défilement plus rapide"),
    ...
    "draw": MessageLookupByLibrary.simpleMessage("Dessiner"),
    ...
    "editAutoAddPeople": MessageLookupByLibrary.simpleMessage(
      "Modifier les personnes auto-ajoutées",
    ),
    ...
    "filter": MessageLookupByLibrary.simpleMessage("Filtres"),
    ...
    "genericProgress": m43,
    "gettingReady": MessageLookupByLibrary.simpleMessage("Préparation"),
    ...
    "groupBy": MessageLookupByLibrary.simpleMessage("Grouper par"),
    ...
    "ignorePerson": MessageLookupByLibrary.simpleMessage("Ignorer la personne"),
    ...
    "lastWeek": MessageLookupByLibrary.simpleMessage("La semaine dernière"),
    ...
    "peopleAutoAddDesc": MessageLookupByLibrary.simpleMessage(
      "Sélectionnez les personnes que vous souhaitez ajouter automatiquement à l\'album",
    ),
    ...
    "sticker": MessageLookupByLibrary.simpleMessage("Autocollant"),
    ...
    "thisMonth": MessageLookupByLibrary.simpleMessage("Ce mois"),
