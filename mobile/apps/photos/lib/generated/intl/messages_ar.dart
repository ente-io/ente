...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m7(count) =>
      "${Intl.plural(count, one: 'تمت الإضافة إلى ألبوم واحد بنجاح', other: 'تم الإضافة إلى ${count} ألبومات بنجاح')}";

  static String m8(name) => "الإعجاب بـ ${name}";

  static String m9(count) =>
      "${Intl.plural(count, zero: 'لا يوجد مُشاركون', one: 'مُشارك واحد', other: '${count} مُشاركين')}";

  static String m10(versionValue) => "الإصدار: ${versionValue}";

  static String m11(freeAmount, storageUnit) =>
      "${freeAmount} ${storageUnit} متوفرة";

  static String m12(name) => "مناظر جميلة مع ${name}";
  ...
  static String m15(isFamilyMember, storageAmountInGb) =>
      "${Intl.select(isFamilyMember, {'true': 'عائلتك حصلت على ${storageAmountInGb} جيجابايت حتى الآن', 'false': 'لقد حصلت على ${storageAmountInGb} جيجابايت حتى الآن', 'other': 'لقد حصلت على ${storageAmountInGb} جيجابايت حتى الآن!'})}";

  static String m16(albumName) => "تم إنشاء رابط تعاوني لـ ${albumName}";
  ...
  static String m21(endpoint) => "متصل بـ ${endpoint}";
  ...
  static String m29(name) => "هذا البريد الإلكتروني مرتبط مسبقاً بـ ${name}.";

  static String m30(newEmail) => "تم تغيير البريد الإلكتروني إلى ${newEmail}";

  static String m31(email) => "${email} لا يملك حساب Ente.";

  static String m32(email) =>
      "${email} لا يملك حسابًا على Ente.\n\nأرسل له دعوة لمشاركة الصور.";

  static String m33(name) => "معانقة ${name}";

  static String m34(text) => "تم العثور على صور إضافية لـ ${text}";

  static String m35(name) => "الاستمتاع بالطعام مع ${name}";
  ...
  static String m39(endDate) => "التجربة المجانية صالحة حتى ${endDate}";

  static String m40(count) =>
      "لا يزال بإمكانك الوصول ${Intl.plural(count, one: 'إليه', two: 'إليهما', other: 'إليها')} على Ente طالما لديك اشتراك نشط.";

  static String m41(sizeInMBorGB) => "تحرير ${sizeInMBorGB}";
  ...
  static String m44(name) => "التنزه مع ${name}";

  static String m45(count) =>
      "${Intl.plural(count, one: '${count} عُنْصُر', other: '${count} عَنَاصِر')}";

  static String m46(name) => "آخر مرة مع ${name}";

  static String m47(email) => "${email} دعاك لتكون جهة اتصال موثوقة";

  static String m48(expiryTime) => "ستنتهي صلاحية الرابط في ${expiryTime}";

  static String m49(email) => "ربط الشخص بـ ${email}";
  ...
  static String m53(albumName) => "تم النقل بنجاح إلى ${albumName}";

  static String m54(personName) => "لا توجد اقتراحات لـ ${personName}";

  static String m55(name) => "ليس ${name}؟";

  static String m56(familyAdminEmail) =>
      "يرجى الاتصال بـ ${familyAdminEmail} لتغيير الرمز الخاص بك.";

  static String m57(name) => "الاحتفال مع ${name}";
  ...
  static String m60(name, age) => "${name} يبلغ ${age}!";

  static String m61(name, age) => "${name} سيبلغ ${age} قريبًا";
  ...
  static String m66(toEmail) => "يرجى إرسال السجلات إلى \n${toEmail}";

  static String m67(name) => "التقاط صور مع ${name}";

  static String m68(folderName) => "جارٍ معالجة ${folderName}...";

  static String m69(storeName) => "قيّمنا على ${storeName}";

  static String m70(name) => "تمت إعادة تعيينك إلى ${name}";
  ...
  static String m73(email) => "${email} يحاول استرداد حسابك.";
  ...
  static String m76(endDate) => "يتجدد الاشتراك في ${endDate}";

  static String m77(name) => "رحلة برية مع ${name}";
  ...
  static String m80(count) => "${count} تم تحديد";

  static String m81(count) => "تم تحديد ${count}";

  static String m82(count, yourCount) =>
      "تم تحديد ${count} (${yourCount} منها لك)";

  static String m83(name) => "صور سيلفي مع ${name}";
  ...
  static String m88(emailIDs) => "تمت المشاركة مع ${emailIDs}";

  static String m89(fileType) => "سيتم حذف ${fileType} من جهازك.";

  static String m90(fileType) => "${fileType} موجود في Ente وعلى جهازك.";

  static String m91(fileType) => "سيتم حذف ${fileType} من Ente.";

  static String m92(name) => "الرياضة مع ${name}";

  static String m93(name) => "تسليط الضوء على ${name}";

  static String m94(storageAmountInGB) => "${storageAmountInGB} جيجابايت";
  ...
  static String m97(endDate) => "سيتم إلغاء اشتراكك في ${endDate}";

  static String m98(completed, total) => "${completed}/${total} ذكريات محفوظة";
  ...
  static String m101(email) => "هذا هو معرّف التحقق الخاص بـ ${email}";
  ...
  static String m103(dateFormat) => "${dateFormat} عبر السنين";
  ...
  static String m105(year) => "رحلة في ${year}";

  static String m106(location) => "رحلة إلى ${location}";
  ...
  static String m109(ignoreReason) => "تم تجاهل التحميل بسبب ${ignoreReason}";

  static String m110(count) => "جارٍ حفظ ${count} ذكريات...";

  static String m111(endDate) => "صالح حتى ${endDate}";

  static String m112(email) => "التحقق من ${email}";

  static String m113(name) => "عرض ${name} لإلغاء الربط";
  ...
  static String m116(name) => "أتمنى لـ${name} عيد ميلاد سعيد! 🎉";
  ...
  static String m118(name) => "أنت و ${name}";

  static String m119(storageSaved) => "لقد حررت ${storageSaved} بنجاح!";

  final messages = _notInlinedMessages(_notInlinedMessages);
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    "aNewVersionOfEnteIsAvailable": MessageLookupByLibrary.simpleMessage(
      "يتوفر إصدار جديد من Ente.",
    ),
    "about": MessageLookupByLibrary.simpleMessage("حول التطبيق"),
    "acceptTrustInvite": MessageLookupByLibrary.simpleMessage("قبول الدعوة"),
    "account": MessageLookupByLibrary.simpleMessage("الحساب"),
    "accountIsAlreadyConfigured": MessageLookupByLibrary.simpleMessage(
      "الحساب تم تكوينه بالفعل.",
    ),
    "accountOwnerPersonAppbarTitle": m0,
    "accountWelcomeBack": MessageLookupByLibrary.simpleMessage("أهلاً بعودتك!"),
    ...
    "activeSessions": MessageLookupByLibrary.simpleMessage("الجلسات النشطة"),
    ...
    "addFromDevice": MessageLookupByLibrary.simpleMessage("إضافة من الجهاز"),
    "addItem": m2,
    ...
    "addNameOrMerge": MessageLookupByLibrary.simpleMessage("إضافة اسم أو دمج"),
    ...
    "addParticipants": MessageLookupByLibrary.simpleMessage("إضافة مشاركين"),
    ...
    "addSomePhotosDesc2": MessageLookupByLibrary.simpleMessage("وجوه مألوفة"),
    ...
    "addToHiddenAlbum": MessageLookupByLibrary.simpleMessage(
      "إضافة إلى الألبوم المخفي",
    ),
    "addTrustedContact": MessageLookupByLibrary.simpleMessage(
      "إضافة جهة اتصال موثوقة",
    ),
    "addViewer": MessageLookupByLibrary.simpleMessage("إضافة مشاهد"),
    "addViewers": m4,
    "addYourPhotosNow": MessageLookupByLibrary.simpleMessage("أضف صورك الآن"),
    "addedAs": MessageLookupByLibrary.simpleMessage("تمت الإضافة كـ"),
    "addedBy": m5,
    "addedSuccessfullyTo": m6,
    "addedToAlbums": m7,
    "addingPhotos": MessageLookupByLibrary.simpleMessage("جاري إضافة الصور"),
    "addingToFavorites": MessageLookupByLibrary.simpleMessage(
      "جارٍ الإضافة إلى المفضلة...",
    ),
    "adjust": MessageLookupByLibrary.simpleMessage("تعديل"),
    "admiringThem": m8,
    ...
    "albumUpdated": MessageLookupByLibrary.simpleMessage("تم تحديث الألبوم"),
    ...
    "align": MessageLookupByLibrary.simpleMessage("محاذاة"),
    "allClear": MessageLookupByLibrary.simpleMessage("✨ كل شيء واضح"),
    "allMemoriesPreserved": MessageLookupByLibrary.simpleMessage(
      "تم حفظ جميع الذكريات",
    ),
    ...
    "allowDownloads": MessageLookupByLibrary.simpleMessage("السماح بالتنزيلات"),
    "allowPeopleToAddPhotos": MessageLookupByLibrary.simpleMessage(
      "السماح للأشخاص بإضافة الصور",
    ),
    ...
    "askDeleteReason": MessageLookupByLibrary.simpleMessage(
      "ما السبب الرئيس لحذف حسابك؟",
    ),
    "askYourLovedOnesToShare": MessageLookupByLibrary.simpleMessage(
      "اطلب من أحبائك المشاركة",
    ),
    ...
    "authToViewYourMemories": MessageLookupByLibrary.simpleMessage(
      "يرجى المصادقة لعرض ذكرياتك.",
    ),
    "authToViewYourRecoveryKey": MessageLookupByLibrary.simpleMessage(
      "يرجى المصادقة لعرض مفتاح الاسترداد الخاص بك.",
    ),
    "authenticating": MessageLookupByLibrary.simpleMessage("جارٍ المصادقة..."),
    ...
    "backupFailed": MessageLookupByLibrary.simpleMessage("فشل النسخ الاحتياطي"),
    ...
    "birthdays": MessageLookupByLibrary.simpleMessage("أعياد الميلاد"),
    "blackFridaySale": MessageLookupByLibrary.simpleMessage(
      "تخفيضات الجمعة السوداء",
    ),
    "blog": MessageLookupByLibrary.simpleMessage("المدونة"),
    "brushColor": MessageLookupByLibrary.simpleMessage("لون الفرشاة"),
    "cLDesc1": MessageLookupByLibrary.simpleMessage(
      "نحن بصدد إطلاق محرر صور جديد ومتقدم يضيف المزيد من إطارات الاقتصاص، والإعدادات المسبقة للفلاتر من أجل تعديلات سريعة، وخيارات الضبط الدقيق التي تشمل التشبع، والتباين، والسطوع، ودرجة الحرارة، وغير ذلك الكثير. يتضمن المحرر الجديد أيضا القدرة على الرسم على صورك وإضافة الرموز التعبيرية كملصقات.",
    ),
    "cLTitle1": MessageLookupByLibrary.simpleMessage("محرر الصور المتقدم"),
    "cLTitle2": MessageLookupByLibrary.simpleMessage("ألبومات ذكية"),
    "cLTitle3": MessageLookupByLibrary.simpleMessage("معرض محسن"),
    "cLTitle4": MessageLookupByLibrary.simpleMessage("تمرير أسرع"),
    ...
    "changeLocationOfSelectedItems": MessageLookupByLibrary.simpleMessage(
      "تغيير موقع العناصر المحددة؟",
    ),
    "changePassword": MessageLookupByLibrary.simpleMessage("تغيير كلمة المرور"),
    "changePasswordTitle": MessageLookupByLibrary.simpleMessage(
      "تغيير كلمة المرور",
    ),
    "changePermissions": MessageLookupByLibrary.simpleMessage("تغيير الإذن؟"),
    "changeYourReferralCode": MessageLookupByLibrary.simpleMessage(
      "تغيير رمز الإحالة الخاص بك",
    ),
    ...
    "clubByCaptureTime": MessageLookupByLibrary.simpleMessage(
      "التجميع حسب وقت الالتقاط",
    ),
    "clubByFileName": MessageLookupByLibrary.simpleMessage(
      "التجميع حسب اسم الملف",
    ),
    "clusteringProgress": MessageLookupByLibrary.simpleMessage("تقدم التجميع"),
    ...
    "collaborativeLink": MessageLookupByLibrary.simpleMessage("رابط تعاوني"),
    ...
    "convertToAlbum": MessageLookupByLibrary.simpleMessage("تحويل إلى ألبوم"),
    ...
    "createOrSelectAlbum": MessageLookupByLibrary.simpleMessage(
      "إنشاء أو تحديد ألبوم",
    ),
    "createPublicLink": MessageLookupByLibrary.simpleMessage("إنشاء رابط عام"),
    ...
    "declineTrustInvite": MessageLookupByLibrary.simpleMessage("رفض الدعوة"),
    "decrypting": MessageLookupByLibrary.simpleMessage("جارٍ فك التشفير..."),
    "decryptingVideo": MessageLookupByLibrary.simpleMessage(
      "جارٍ فك تشفير الفيديو...",
    ),
    ...
    "deleteEmptyAlbums": MessageLookupByLibrary.simpleMessage(
      "حذف الألبومات الفارغة",
    ),
    "deleteEmptyAlbumsWithQuestionMark": MessageLookupByLibrary.simpleMessage(
      "حذف الألبومات الفارغة؟",
    ),
    "deleteFromBoth": MessageLookupByLibrary.simpleMessage("الحذف من كليهما"),
    "deleteFromDevice": MessageLookupByLibrary.simpleMessage("الحذف من الجهاز"),
    ...
    "designedToOutlive": MessageLookupByLibrary.simpleMessage("مصممة لتدوم"),
    "details": MessageLookupByLibrary.simpleMessage("التفاصيل"),
    "developerSettings": MessageLookupByLibrary.simpleMessage("إعدادات المطور"),
    ...
    "different": MessageLookupByLibrary.simpleMessage("مختلف"),
    ...
    "discover_celebrations": MessageLookupByLibrary.simpleMessage("الاحتفالات"),
    "discover_food": MessageLookupByLibrary.simpleMessage("الطعام"),
    "discover_greenery": MessageLookupByLibrary.simpleMessage(
      "المساحات الخضراء",
    ),
    ...
    "discover_pets": MessageLookupByLibrary.simpleMessage("الحيوانات الأليفة"),
    ...
    "doNotSignOut": MessageLookupByLibrary.simpleMessage("عدم تسجيل الخروج"),
    ...
    "draw": MessageLookupByLibrary.simpleMessage("رسم"),
    ...
    "emptyTrash": MessageLookupByLibrary.simpleMessage("إفراغ سلة المهملات؟"),
    ...
    "encryptionKeys": MessageLookupByLibrary.simpleMessage("مفاتيح التشفير"),
    ...
    "enterAlbumName": MessageLookupByLibrary.simpleMessage("أدخل اسم الألبوم"),
    ...
    "enterPersonName": MessageLookupByLibrary.simpleMessage("أدخل اسم الشخص"),
    ...
    "faceThumbnailGenerationFailed": MessageLookupByLibrary.simpleMessage(
      "تعذر إنشاء الصور المصغرة للوجه",
    ),
    ...
    "familyPlanPortalTitle": MessageLookupByLibrary.simpleMessage("العائلة"),
    ...
    "filesSavedToGallery": MessageLookupByLibrary.simpleMessage(
      "تم حفظ الملفات في المعرض.",
    ),
    "filter": MessageLookupByLibrary.simpleMessage("فلتر"),
    "findPeopleByName": MessageLookupByLibrary.simpleMessage(
      "البحث عن الأشخاص بسرعة بالاسم",
    ),
    "findThemQuickly": MessageLookupByLibrary.simpleMessage("اعثر عليهم بسرعة"),
    ...
    "foundFaces": MessageLookupByLibrary.simpleMessage(
      "الوجوه التي تم العثور عليها",
    ),
    ...
    "genericProgress": m43,
    "gettingReady": MessageLookupByLibrary.simpleMessage("جاري الإعداد"),
    "goToSettings": MessageLookupByLibrary.simpleMessage(
      "الانتقال إلى الإعدادات",
    ),
    "googlePlayId": MessageLookupByLibrary.simpleMessage("معرّف Google Play"),
    ...
    "happyBirthday": MessageLookupByLibrary.simpleMessage("عيد ميلاد سعيد! 🥳"),
    "hearUsExplanation": MessageLookupByLibrary.simpleMessage(
      "نحن لا نتتبع عمليات تثبيت التطبيق. سيساعدنا إذا أخبرتنا أين وجدتنا!",
    ),
    "hearUsWhereTitle": MessageLookupByLibrary.simpleMessage(
      "كيف سمعت عن Ente؟ (اختياري)",
    ),
    ...
    "ignorePerson": MessageLookupByLibrary.simpleMessage("تجاهل الشخص"),
    ...
    "indexedItems": MessageLookupByLibrary.simpleMessage("العناصر المفهرسة"),
    ...
    "installManually": MessageLookupByLibrary.simpleMessage("التثبيت يدويًا"),
    "invalidEmailAddress": MessageLookupByLibrary.simpleMessage(
      "عنوان البريد الإلكتروني غير صالح",
    ),
    "invalidEndpoint": MessageLookupByLibrary.simpleMessage(
      "نقطة النهاية غير صالحة",
    ),
    ...
    "inviteYourFriends": MessageLookupByLibrary.simpleMessage("ادعُ أصدقاءك"),
    "inviteYourFriendsToEnte": MessageLookupByLibrary.simpleMessage(
      "ادعُ أصدقاءك إلى Ente",
    ),
    ...
    "joinAlbum": MessageLookupByLibrary.simpleMessage("الانضمام إلى الألبوم"),
    ...
    "joinDiscord": MessageLookupByLibrary.simpleMessage("الانضمام إلى Discord"),
    ...
    "lastYearsTrip": MessageLookupByLibrary.simpleMessage("رحلة العام الماضي"),
    ...
    "leaveFamily": MessageLookupByLibrary.simpleMessage("مغادرة خطة العائلة"),
    "leaveSharedAlbum": MessageLookupByLibrary.simpleMessage(
      "مغادرة الألبوم المشترك؟",
    ),
    "left": MessageLookupByLibrary.simpleMessage("يسار"),
    "legacy": MessageLookupByLibrary.simpleMessage("جهات الاتصال الموثوقة"),
    "legacyAccounts": MessageLookupByLibrary.simpleMessage("الحسابات الموثوقة"),
    "legacyInvite": m47,
    ...
    "linkEmail": MessageLookupByLibrary.simpleMessage("ربط البريد الإلكتروني"),
    ...
    "linkExpiresOn": m48,
    "linkExpiry": MessageLookupByLibrary.simpleMessage("انتهاء صلاحية الرابط"),
    ...
    "localIndexing": MessageLookupByLibrary.simpleMessage("الفهرسة المحلية"),
    ...
    "loopVideoOff": MessageLookupByLibrary.simpleMessage("إيقاف تكرار الفيديو"),
    "loopVideoOn": MessageLookupByLibrary.simpleMessage("تشغيل تكرار الفيديو"),
    ...
    "manageParticipants": MessageLookupByLibrary.simpleMessage(
      "إدارة المشاركين",
    ),
    ...
    "memoryCount": m51,
    "merchandise": MessageLookupByLibrary.simpleMessage("المنتجات الترويجية"),
    ...
    "mlConsentTitle": MessageLookupByLibrary.simpleMessage("تمكين تعلم الآلة؟"),
    ...
    "newPhotosEmoji": MessageLookupByLibrary.simpleMessage(" جديد 📸"),
    ...
    "noExifData": MessageLookupByLibrary.simpleMessage("لا توجد بيانات EXIF"),
    "noFacesFound": MessageLookupByLibrary.simpleMessage(
      "لم يتم العثور على وجوه",
    ),
    "noHiddenPhotosOrVideos": MessageLookupByLibrary.simpleMessage(
      "لا توجد صور أو مقاطع فيديو مخفية",
    ),
    "noImagesWithLocation": MessageLookupByLibrary.simpleMessage(
      "لا توجد صور تحتوي على موقع",
    ),
    ...
    "noPhotosFoundHere": MessageLookupByLibrary.simpleMessage(
      "لم يتم العثور على صور هنا",
    ),
    "noQuickLinksSelected": MessageLookupByLibrary.simpleMessage(
      "لم يتم تحديد روابط سريعة.",
    ),
    "noRecoveryKey": MessageLookupByLibrary.simpleMessage(
      "لا تملك مفتاح استرداد؟",
    ),
    ...
    "onTheRoad": MessageLookupByLibrary.simpleMessage("على الطريق مرة أخرى"),
    ...
    "optionalAsShortAsYouLike": MessageLookupByLibrary.simpleMessage(
      "اختياري، قصير كما تشاء...",
    ),
    "orMergeWithExistingPerson": MessageLookupByLibrary.simpleMessage(
      "أو الدمج مع شخص موجود",
    ),
    "orPickAnExistingOne": MessageLookupByLibrary.simpleMessage(
      "أو اختر واحدًا موجودًا",
    ),
    "orPickFromYourContacts": MessageLookupByLibrary.simpleMessage(
      "أو اختر من جهات اتصالك",
    ),
    "otherDetectedFaces": MessageLookupByLibrary.simpleMessage(
      "وجوه أخرى تم اكتشافها",
    ),
    "pair": MessageLookupByLibrary.simpleMessage("إقران"),
    "pairWithPin": MessageLookupByLibrary.simpleMessage("الإقران بالرمز السري"),
    "pairingComplete": MessageLookupByLibrary.simpleMessage("اكتمل الإقران"),
    "panorama": MessageLookupByLibrary.simpleMessage("بانوراما"),
    "partyWithThem": m57,
    "passKeyPendingVerification": MessageLookupByLibrary.simpleMessage(
      "التحقق لا يزال معلقًا.",
    ),
    "passkey": MessageLookupByLibrary.simpleMessage("مفتاح المرور"),
    "passkeyAuthTitle": MessageLookupByLibrary.simpleMessage(
      "التحقق من مفتاح المرور",
    ),
    ...
    "pastYearsMemories": MessageLookupByLibrary.simpleMessage(
      "ذكريات السنوات الماضية",
    ),
    "paymentDetails": MessageLookupByLibrary.simpleMessage("تفاصيل الدفع"),
    "paymentFailed": MessageLookupByLibrary.simpleMessage("فشلت عملية الدفع"),
    ...
    "peopleAutoAddDesc": MessageLookupByLibrary.simpleMessage(
      "حدد الأشخاص الذين تريد إضافتهم تلقائيا إلى الألبوم",
    ),
    "peopleUsingYourCode": MessageLookupByLibrary.simpleMessage(
      "الأشخاص الذين يستخدمون رمزك",
    ),
    ...
    "photoDescriptions": MessageLookupByLibrary.simpleMessage("أوصاف الصور"),
    ...
    "privateBackups": MessageLookupByLibrary.simpleMessage("نسخ احتياطية خاصة"),
    ...
    "rateUsOnStore": m69,
    "reassignMe": MessageLookupByLibrary.simpleMessage("إعادة تعيين \"أنا\""),
    ...
    "recoveryAccount": MessageLookupByLibrary.simpleMessage("استرداد الحساب"),
    "recoveryInitiated": MessageLookupByLibrary.simpleMessage("بدء الاسترداد"),
    ...
    "reenterPin": MessageLookupByLibrary.simpleMessage("إعادة إدخال رمز PIN"),
    "referFriendsAnd2xYourPlan": MessageLookupByLibrary.simpleMessage(
      "أحِل الأصدقاء وضاعف خطتك مرتين",
    ),
    "referralStep1": MessageLookupByLibrary.simpleMessage(
      "1. أعطِ هذا الرمز لأصدقائك",
    ),
    "referralStep2": MessageLookupByLibrary.simpleMessage(
      "2. يشتركون في خطة مدفوعة",
    ),
    "referralStep3": m74,
    "referrals": MessageLookupByLibrary.simpleMessage("الإحالات"),
    "referralsAreCurrentlyPaused": MessageLookupByLibrary.simpleMessage(
      "الإحالات متوقفة مؤقتًا",
    ),
    ...
    "removeFromAlbum": MessageLookupByLibrary.simpleMessage("إزالة من الألبوم"),
    ...
    "removeParticipant": MessageLookupByLibrary.simpleMessage("إزالة المشارك"),
    ...
    "sameperson": MessageLookupByLibrary.simpleMessage("نفس الشخص؟"),
    "save": MessageLookupByLibrary.simpleMessage("حفظ"),
    "saveAsAnotherPerson": MessageLookupByLibrary.simpleMessage("حفظ كشخص آخر"),
    "saveChangesBeforeLeavingQuestion": MessageLookupByLibrary.simpleMessage(
      "حفظ التغييرات قبل المغادرة؟",
    ),
    ...
    "searchHint1": MessageLookupByLibrary.simpleMessage("بحث سريع على الجهاز"),
    "searchHint2": MessageLookupByLibrary.simpleMessage(
      "تواريخ الصور، الأوصاف",
    ),
    ...
    "selectItemsToAdd": MessageLookupByLibrary.simpleMessage(
      "تحديد العناصر للإضافة",
    ),
    "selectLanguage": MessageLookupByLibrary.simpleMessage("اختر اللغة"),
    "selectMailApp": MessageLookupByLibrary.simpleMessage("تحديد تطبيق البريد"),
    "selectMorePhotos": MessageLookupByLibrary.simpleMessage(
      "تحديد المزيد من الصور",
    ),
    "selectOneDateAndTime": MessageLookupByLibrary.simpleMessage(
      "تحديد تاريخ ووقت واحد",
    ),
    ...
    "serverEndpoint": MessageLookupByLibrary.simpleMessage("نقطة نهاية الخادم"),
    "sessionExpired": MessageLookupByLibrary.simpleMessage(
      "انتهت صلاحية الجلسة",
    ),
    "sessionIdMismatch": MessageLookupByLibrary.simpleMessage(
      "عدم تطابق معرّف الجلسة",
    ),
    ...
    "sharedByMe": MessageLookupByLibrary.simpleMessage("تمت مشاركتها بواسطتي"),
    "sharedByYou": MessageLookupByLibrary.simpleMessage("تمت مشاركتها بواسطتك"),
    ...
    "sharedWith": m88,
    "sharedWithMe": MessageLookupByLibrary.simpleMessage("تمت مشاركتها معي"),
    "sharedWithYou": MessageLookupByLibrary.simpleMessage("تمت مشاركتها معك"),
    "sharing": MessageLookupByLibrary.simpleMessage("جارٍ المشاركة..."),
    "shiftDatesAndTime": MessageLookupByLibrary.simpleMessage(
      "تغيير التواريخ والوقت",
    ),
    ...
    "smartMemories": MessageLookupByLibrary.simpleMessage("ذكريات ذكية"),
    ...
    "startBackup": MessageLookupByLibrary.simpleMessage("بدء النسخ الاحتياطي"),
    "status": MessageLookupByLibrary.simpleMessage("الحالة"),
    "sticker": MessageLookupByLibrary.simpleMessage("ملصق"),
    ...
    "tapToEnterCode": MessageLookupByLibrary.simpleMessage("انقر لإدخال الرمز"),
    ...
    "terminateSession": MessageLookupByLibrary.simpleMessage("إنهاء الجَلسةِ؟"),
    "terms": MessageLookupByLibrary.simpleMessage("الشروط"),
    "termsOfServicesTitle": MessageLookupByLibrary.simpleMessage("شروط الخدمة"),
    ...
    "theseItemsWillBeDeletedFromYourDevice":
        MessageLookupByLibrary.simpleMessage("سيتم حذف هذه العناصر من جهازك."),
    "theyAlsoGetXGb": m100,
    ...
    "unhideToAlbum": MessageLookupByLibrary.simpleMessage("إظهار في الألبوم"),
    ...
    "unpinAlbum": MessageLookupByLibrary.simpleMessage("إلغاء تثبيت الألبوم"),
    ...
    "viewAllExifData": MessageLookupByLibrary.simpleMessage(
      "عرض جميع بيانات EXIF",
    ),
    "viewLargeFiles": MessageLookupByLibrary.simpleMessage("الملفات الكبيرة"),
