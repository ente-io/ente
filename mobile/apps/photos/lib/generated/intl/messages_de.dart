...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m7(count) =>
      "${Intl.plural(count, one: 'Erfolgreich zu einem Album hinzugefügt', other: 'Erfolgreich zu ${count} Alben hinzugefügt')}";

  static String m8(name) => "${name} wertschätzen";
  ...
  static String m12(name) => "Schöne Ausblicke mit ${name}";
  ...
  static String m39(endDate) => "Kostenlose Demo verfügbar bis zum ${endDate}";
  ...
  static String m44(name) => "Wandern mit ${name}";

  static String m45(count) =>
      "${Intl.plural(count, one: '${count} Objekt', other: '${count} Objekte')}";

  static String m46(name) => "Zuletzt mit ${name}";

  static String m47(email) =>
      "${email} hat dich eingeladen, ein vertrauenswürdiger Kontakt zu werden";

  static String m48(expiryTime) => "Link läuft am ${expiryTime} ab";

  static String m49(email) => "Person mit ${email} verknüpfen";
  ...
  static String m53(albumName) => "Erfolgreich zu ${albumName} hinzugefügt";

  static String m54(personName) => "Keine Vorschläge für ${personName}";

  static String m55(name) => "Nicht ${name}?";

  static String m56(familyAdminEmail) =>
      "Bitte wende Dich an ${familyAdminEmail}, um den Code zu ändern.";

  static String m57(name) => "Party mit ${name}";
  ...
  static String m60(name, age) => "${name} ist ${age}!";

  static String m61(name, age) => "${name} wird bald ${age}";
  ...
  static String m65(toEmail) => "Bitte sende uns eine E-Mail an ${toEmail}";

  static String m66(toEmail) => "Bitte sende die Protokolle an ${toEmail}";

  static String m67(name) => "Posieren mit ${name}";

  static String m68(folderName) => "Verarbeite ${folderName}...";

  static String m69(storeName) => "Bewerte uns auf ${storeName}";

  static String m70(name) => "Du wurdest an ${name} neu zugewiesen";
  ...
  static String m76(endDate) => "Erneuert am ${endDate}";

  static String m77(name) => "Roadtrip mit ${name}";
  ...
  static String m81(count) => "${count} ausgewählt";

  static String m82(count, yourCount) =>
      "${count} ausgewählt (${yourCount} von Ihnen)";

  static String m83(name) => "Selfies mit ${name}";
  ...
  static String m88(emailIDs) => "Geteilt mit ${emailIDs}";
  ...
  static String m91(fileType) => "Diese Datei wird von Ente gelöscht.";

  static String m92(name) => "Sport mit ${name}";

  static String m93(name) => "Spot auf ${name}";
  ...
  static String m97(endDate) => "Dein Abo endet am ${endDate}";
  ...
  static String m101(email) => "Dies ist ${email}s Verifizierungs-ID";

  static String m102(count) =>
      "${Intl.plural(count, one: 'Diese Woche, vor einem Jahr', other: 'Diese Woche, vor ${count} Jahren')}";

  static String m103(dateFormat) => "${dateFormat} über die Jahre";

  static String m104(count) =>
      "${Intl.plural(count, zero: 'Demnächst', one: '1 Tag', other: '${count} Tage')}";

  static String m105(year) => "Reise in ${year}";

  static String m106(location) => "Ausflug nach ${location}";
  ...
  static String m110(count) => "Sichere ${count} Erinnerungsstücke...";

  static String m111(endDate) => "Gültig bis ${endDate}";

  static String m112(email) => "Verifiziere ${email}";

  static String m113(name) => "${name} zum Entfernen des Links anzeigen";
  ...
  static String m116(name) => "Wünsche ${name} alles Gute zum Geburtstag! 🎉";

  static String m117(count) =>
      "${Intl.plural(count, one: 'vor einem Jahr', other: 'vor ${count} Jahren')}";

  static String m118(name) => "Du und ${name}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "addSomePhotosDesc1": MessageLookupByLibrary.simpleMessage(
      "Fotos hinzufügen oder auswählen ",
    ),
    ...
    "addedToAlbums": m7,
    "addingPhotos": MessageLookupByLibrary.simpleMessage("Füge Fotos hinzu"),
    "addingToFavorites": MessageLookupByLibrary.simpleMessage(
      "Wird zu Favoriten hinzugefügt...",
    ),
    "adjust": MessageLookupByLibrary.simpleMessage("Anpassen"),
    "admiringThem": m8,
    ...
    "align": MessageLookupByLibrary.simpleMessage("Ausrichten"),
    ...
    "autoAddPeople": MessageLookupByLibrary.simpleMessage(
      "Personen automatisch hinzufügen",
    ),
    "autoAddToAlbum": MessageLookupByLibrary.simpleMessage(
      "Automatisch zu Album hinzufügen",
    ),
    ...
    "brushColor": MessageLookupByLibrary.simpleMessage("Pinselfarbe"),
    "cLDesc1": MessageLookupByLibrary.simpleMessage(
      "Wir veröffentlichen eine neue und erweiterte Bildbearbeitung, die mehr Bildzuschnitte ermöglicht, vordefinierte Filter für schnelleres Bearbeiten bietet, sowie die Feinabstimmung von Sättigung, Kontrast, Helligkeit und vielem mehr erlaubt. Der neue Editor erlaubt außerdem das Zeichnen auf den Fotos oder das Hinzufügen von Emojis als Sticker.",
    ),
    "cLDesc2": MessageLookupByLibrary.simpleMessage(
      "Du kannst jetzt automatisch Fotos von ausgewählten Personen zu jedem Album hinzufügen. Öffne einfach das Album und wähle \"Personen automatisch hinzufügen\" aus dem Menü. Zusammen mit einem geteilten Album kannst Du Fotos mit null Klicks teilen.",
    ),
    "cLDesc3": MessageLookupByLibrary.simpleMessage(
      "Wir haben die Möglichkeit hinzugefügt, Alben nach Wochen, Monaten und Jahren zu gruppieren. Du kannst jetzt die Galerie mit diesen neuen Gruppierungs-Optionen so anpassen, dass sie genau so aussieht, wie Du möchtest, zusammen mit angepassten Rastern",
    ),
    "cLDesc4": MessageLookupByLibrary.simpleMessage(
      "Zusammen mit einem Schwung Änderungen unter der Haube, um das Erlebnis beim Scrollen der Galerie zu verbessern, haben wir außerdem den Scrollbalken mit Markern neu gestaltet, um es Dir zu ermöglichen, schnell in der Zeitleiste zu springen.",
    ),
    ...
    "cLTitle4": MessageLookupByLibrary.simpleMessage("Schnelleres Scrollen"),
    ...
    "draw": MessageLookupByLibrary.simpleMessage("Zeichnen"),
    ...
    "font": MessageLookupByLibrary.simpleMessage("Schriftart"),
    ...
    "genericProgress": m43,
    "gettingReady": MessageLookupByLibrary.simpleMessage("Vorbereitung"),
    ...
    "groupBy": MessageLookupByLibrary.simpleMessage("Gruppieren nach"),
    ...
    "ignorePerson": MessageLookupByLibrary.simpleMessage("Person ignorieren"),
    ...
    "peopleAutoAddDesc": MessageLookupByLibrary.simpleMessage(
      "Wähle die Personen, die du automatisch zum Album hinzufügen möchtest",
    ),
    ...
    "redo": MessageLookupByLibrary.simpleMessage("Wiederherstellen"),
