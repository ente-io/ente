...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m7(count) =>
      "${Intl.plural(count, one: 'Adicionado com sucesso a 1 álbum', other: 'Adicionado com sucesso a ${count} álbuns')}";

  static String m8(name) => "A admirar ${name}";

  static String m9(count) =>
      "${Intl.plural(count, zero: 'Nenhum participante', one: '1 participante', other: '${count} participantes')}";

  static String m10(versionValue) => "Versão: ${versionValue}";

  static String m11(freeAmount, storageUnit) =>
      "${freeAmount} ${storageUnit} grátis";

  static String m12(name) => "Vistas deslumbrantes com ${name}";
  ...
  static String m16(albumName) => "Link colaborativo criado para ${albumName}";
  ...
  static String m29(name) => "Este e-mail já está ligado a ${name}.";

  static String m30(newEmail) => "Email alterado para ${newEmail}";

  static String m31(email) => "${email} não há uma conta no Ente.";

  static String m32(email) =>
      "${email} não possui uma conta Ente.\n\nEnvie um convite para compartilhar fotos.";

  static String m33(name) => "A abraçar ${name}";

  static String m34(text) => "Fotos extras encontradas para ${text}";

  static String m35(name) => "A comer com ${name}";
  ...
  static String m39(endDate) => "Teste gratuito válido até ${endDate}";

  static String m40(count) =>
      "Ainda pode acessá${Intl.plural(count, one: '-lo', other: '-los')} no Ente contanto que tenha uma subscrição ativa";

  static String m41(sizeInMBorGB) => "Libertar ${sizeInMBorGB}";
  ...
  static String m44(name) => "Passeando com ${name}";
  ...
  static String m49(email) => "Ligar pessoa a ${email}";
  ...
  static String m57(name) => "Tendo uma festa com ${name}";
  ...
  static String m60(name, age) => "${name} tem ${age} anos!";

  static String m61(name, age) => "${name} fará ${age} anos em breve";
  ...
  static String m73(email) => "${email} está a tentar recuperar a sua conta.";
  ...
  static String m77(name) => "A viajar na rua com ${name}";
  ...
  static String m83(name) => "A captar selfies com ${name}";
  ...
  static String m92(name) => "A praticar esportes com ${name}";

  static String m93(name) => "A dar destaque em ${name}";
  ...
  static String m103(dateFormat) => "${dateFormat} com o avanço dos anos";
  ...
  static String m106(location) => "Viagem para ${location}";
  ...
  static String m113(name) => "Ver ${name} para desligar";
  ...
  static String m116(name) => "Envie um \"Felicidades\" a ${name}! 🎉";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "addSomePhotosDesc1": MessageLookupByLibrary.simpleMessage(
      "Adicione algumas fotos ou selecione ",
    ),
    ...
    "addedToAlbums": m7,
    "addingPhotos": MessageLookupByLibrary.simpleMessage("A adicionar fotos"),
    "addingToFavorites": MessageLookupByLibrary.simpleMessage(
      "Adicionando aos favoritos...",
    ),
    "adjust": MessageLookupByLibrary.simpleMessage("Ajuste"),
    "admiringThem": m8,
    ...
    "align": MessageLookupByLibrary.simpleMessage("Alinhar"),
    ...
    "brushColor": MessageLookupByLibrary.simpleMessage("Cor do pincel"),
    "cLDesc1": MessageLookupByLibrary.simpleMessage(
      "Estamos a lançar um novo editor avançado que adiciona mais ecrãs de recorte, predefinições de filtro para edições ágeis, ajustes de afinação incluindo saturação, contraste, brilho, temperatura e mais além. O novo editor também será possível desenhar nas suas fotos e adicionar emojis como autocolantes.",
    ),
    "cLDesc2": MessageLookupByLibrary.simpleMessage(
      "Agora pode automaticamente adicionar fotos de pessoas selecionadas para qualquer álbum. É só ir até o álbum, e clicar \"auto adicionar pessoa\" no menu expandido. Se usado com o álbum, pode partilhar fotos sem esforço.",
    ),
    "cLDesc3": MessageLookupByLibrary.simpleMessage(
      "Adicionamos o agrupamento à sua fototeca, com filtro de semanas, meses, e anos. Pode personalizar a sua fototeca para parecer como desejar ao usar as novas definições de agrupamento, junto às grades personalizadas",
    ),
    "cLDesc4": MessageLookupByLibrary.simpleMessage(
      "Junto às improvisações salva-vidas para melhorar a experiência de arraste na fototeca, também redesenhamos o slider para mostrar marcadores, permitindo você pular a linha do tempo mais fácil.",
    ),
    "cLTitle1": MessageLookupByLibrary.simpleMessage(
      "Editor de Imagens Avançado",
    ),
    "cLTitle2": MessageLookupByLibrary.simpleMessage("Álbuns Inteligentes"),
    "cLTitle3": MessageLookupByLibrary.simpleMessage("Fototeca Improvisada"),
    "cLTitle4": MessageLookupByLibrary.simpleMessage("Arraste Ágil"),
    ...
    "draw": MessageLookupByLibrary.simpleMessage("Desenho"),
    ...
    "font": MessageLookupByLibrary.simpleMessage("Fonte"),
    ...
    "genericProgress": m43,
    "gettingReady": MessageLookupByLibrary.simpleMessage("A preparar"),
    ...
    "ignorePerson": MessageLookupByLibrary.simpleMessage("Ignorar pessoa"),
    ...
    "peopleAutoAddDesc": MessageLookupByLibrary.simpleMessage(
      "Selecione as pessoas que quer auto adicionar ao álbum",
    ),
    ...
    "redo": MessageLookupByLibrary.simpleMessage("Refazer"),
    ...
    "sticker": MessageLookupByLibrary.simpleMessage("Autocolante"),
