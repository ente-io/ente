...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(count) =>
      "${Intl.plural(count, zero: 'Dodaj współuczestnika', one: 'Dodaj współuczestnika', other: 'Dodaj współuczestników')}";

  static String m2(count) =>
      "${Intl.plural(count, one: 'Dodaj element', few: 'Dodaj elementy', many: 'Dodaj elementów', other: 'Dodaj elementów')}";

  static String m3(storageAmount, endDate) =>
      "Twój dodatek ${storageAmount} jest ważny do ${endDate}";

  static String m4(count) =>
      "${Intl.plural(count, zero: 'Dodaj widza', one: 'Dodaj widza', other: 'Dodaj widzów')}";
  ...
  static String m7(count) =>
      "${Intl.plural(count, one: 'Pomyślnie dodano do 1 albumu', other: 'Pomyślnie dodano do ${count} albumów')}";

  static String m8(name) => "Podziwianie ${name}";
  ...
  static String m12(name) => "Piękne widoki z ${name}";
  ...
  static String m16(albumName) => "Utworzono link współpracy dla ${albumName}";
  ...
  static String m29(name) => "Ten e-mail jest już powiązany z ${name}.";

  static String m30(newEmail) => "Adres e-mail został zmieniony na ${newEmail}";

  static String m31(email) => "${email} nie posiada konta Ente.";

  static String m32(email) =>
      "${email} nie posiada konta Ente.\n\nWyślij im zaproszenie do udostępniania zdjęć.";

  static String m33(name) => "Obejmowanie ${name}";

  static String m34(text) => "Znaleziono dodatkowe zdjęcia dla ${text}";

  static String m35(name) => "Ucztowanie z ${name}";
  ...
  static String m39(endDate) => "Okres próbny ważny do ${endDate}";

  static String m40(count) =>
      "Nadal możesz mieć dostęp ${Intl.plural(count, one: 'do tego', other: 'do tych')} na Ente tak długo, jak masz aktywną subskrypcję";

  static String m41(sizeInMBorGB) => "Zwolnij ${sizeInMBorGB}";

  static String m42(count, formattedSize) =>
      "${Intl.plural(count, one: 'Może zostać usunięty z urządzenia, aby zwolnić ${formattedSize}', many: 'Może być usuniętych z urządzenia, aby zwolnić ${formattedSize}', other: 'Mogą być usunięte z urządzenia, aby zwolnić ${formattedSize}')}";

  static String m43(currentlyProcessing, totalCount) =>
      "Przetwarzanie ${currentlyProcessing} / ${totalCount}";

  static String m44(name) => "Wędrówka z ${name}";

  static String m45(count) =>
      "${Intl.plural(count, one: '${count} element', few: '${count} elementy', many: '${count} elementów', other: '${count} elementu')}";

  static String m46(name) => "Ostatnio z ${name}";
  ...
  static String m49(email) => "Połącz osobę z ${email}";

  static String m50(personName, email) =>
      "Spowoduje to powiązanie ${personName} z ${email}";

  static String m51(count, formattedCount) =>
      "${Intl.plural(count, zero: 'brak wspomnień', one: '${formattedCount} wspomnienie', few: '${formattedCount} wspomnienia', many: '${formattedCount} wspomnień', other: '${formattedCount} wspomnień')}";

  static String m52(count) =>
      "${Intl.plural(count, one: 'Przenieś element', few: 'Przenieś elementy', many: 'Przenieś elementów', other: 'Przenieś elementów')}";
  ...
  static String m57(name) => "Impreza z ${name}";
  ...
  static String m60(name, age) => "${name} ma ${age} lat!";

  static String m61(name, age) => "${name} wkrótce będzie mieć ${age} lat";

  static String m62(count) =>
      "${Intl.plural(count, zero: 'Brak zdjęć', one: '1 zdjęcie', few: '${count} zdjęcia', many: '${count} zdjęć', other: '${count} zdjęć')}";

  static String m63(count) =>
      "${Intl.plural(count, zero: '0 zdjęć', one: '1 zdjęcie', few: '${count} zdjęcia', many: '${count} zdjęć', other: '${count} zdjęć')}";
  ...
  static String m77(name) => "Wycieczka z ${name}";
  ...
  static String m83(name) => "Selfie z ${name}";
  ...
  static String m92(name) => "Sport z ${name}";

  static String m93(name) => "Uwaga na ${name}";
  ...
  static String m102(count) =>
      "${Intl.plural(count, one: 'W tym tygodniu, ${count} rok temu', few: 'W tym tygodniu, ${count} lata temu', many: 'W tym tygodniu, ${count} lat temu', other: 'W tym tygodniu, ${count} lat temu')}";

  static String m103(dateFormat) => "${dateFormat} przez lata";

  static String m104(count) =>
      "${Intl.plural(count, zero: 'Wkrótce', one: '1 dzień', few: '${count} dni', other: '${count} dni')}";

  static String m105(year) => "Podróż w ${year}";

  static String m106(location) => "Wyjazd do ${location}";
  ...
  static String m113(name) => "Zobacz ${name}, aby odłączyć";
  ...
  static String m116(name) => "Życz ${name} wszystkiego  najlepszego! 🎉";
  ...
  static String m118(name) => "Ty i ${name}";

  static String m119(storageSaved) => "Pomyślnie zwolniłeś/aś ${storageSaved}!";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "addSomePhotosDesc1": MessageLookupByLibrary.simpleMessage(
      "Dodaj jakieś zdjęcia lub wybierz ",
    ),
    "addSomePhotosDesc2": MessageLookupByLibrary.simpleMessage("znane twarze"),
    ...
    "addedToAlbums": m7,
    "addingPhotos": MessageLookupByLibrary.simpleMessage("Dodawanie zdjęć"),
    "addingToFavorites": MessageLookupByLibrary.simpleMessage(
      "Dodawanie do ulubionych...",
    ),
    "adjust": MessageLookupByLibrary.simpleMessage("Dostosuj"),
    "admiringThem": m8,
    ...
    "align": MessageLookupByLibrary.simpleMessage("Wyrównaj"),
    ...
    "analysis": MessageLookupByLibrary.simpleMessage("Analiza"),
    ...
    "autoAddPeople": MessageLookupByLibrary.simpleMessage(
      "Automatycznie dodaj osoby",
    ),
    "autoAddToAlbum": MessageLookupByLibrary.simpleMessage(
      "Automatycznie dodaj do albumu",
    ),
    ...
    "background": MessageLookupByLibrary.simpleMessage("Tło"),
    ...
    "brushColor": MessageLookupByLibrary.simpleMessage("Kolor Pędzla"),
    "cLDesc1": MessageLookupByLibrary.simpleMessage(
      "Wydajemy nowy i zaawansowany edytor obrazów, który dodaje więcej klatek przycinania, filtry dla szybkich edycji, precyzyjne opcje dostrajania, w tym nasycenie, kontrast, jasność, temperatura i wiele więcej. Nowy edytor zawiera również możliwość rysowania zdjęć i dodawania emotikonów jako naklejki.",
    ),
    "cLDesc2": MessageLookupByLibrary.simpleMessage(
      "Teraz możesz automatycznie dodawać zdjęcia wybranych osób do dowolnego albumu. Po prostu przejdź do albumu i wybierz \"automatycznie dodaj osoby\" z menu przepełnienia. Jeśli używane razem z udostępnionym albumem, możesz udostępniać zdjęcia bez żadnych kliknięć.",
    ),
    "cLDesc3": MessageLookupByLibrary.simpleMessage(
      "Dodaliśmy możliwość grupowania Twojej galerii po tygodniach, miesiącach i latach. Możesz teraz spersonalizować swoją galerię, aby dokładnie wyglądać w ten sposób z nowymi opcjami grupowania, wraz z niestandardowymi siatkami",
    ),
    "cLDesc4": MessageLookupByLibrary.simpleMessage(
      "Wraz z kilkoma ulepszeniami w celu poprawy doświadczenia galerii, przeprojektowaliśmy również pasek przewijania, aby pokazywać znaczniki, umożliwiając szybki skok po osi czasu.",
    ),
    "cLTitle1": MessageLookupByLibrary.simpleMessage(
      "Zaawansowany Edytor Obrazów",
    ),
    ...
    "draw": MessageLookupByLibrary.simpleMessage("Rysuj"),
    ...
    "editAutoAddPeople": MessageLookupByLibrary.simpleMessage(
      "Edytuj automatyczne dodawanie osób",
    ),
    ...
    "font": MessageLookupByLibrary.simpleMessage("Czcionka"),
    ...
    "genericProgress": m43,
    "gettingReady": MessageLookupByLibrary.simpleMessage("Przygotowywanie"),
    ...
    "ignorePerson": MessageLookupByLibrary.simpleMessage("Ignoruj osobę"),
    ...
    "lastWeek": MessageLookupByLibrary.simpleMessage("Zeszły tydzień"),
    ...
    "link": MessageLookupByLibrary.simpleMessage("Połącz"),
    ...
    "linkPerson": MessageLookupByLibrary.simpleMessage("Połącz osobę"),
    ...
    "peopleAutoAddDesc": MessageLookupByLibrary.simpleMessage(
      "Wybierz osoby, które chcesz automatycznie dodać do albumu",
    ),
    ...
    "playStream": MessageLookupByLibrary.simpleMessage("Odtwórz transmisję"),
    ...
    "redo": MessageLookupByLibrary.simpleMessage("Ponów"),
    ...
    "sticker": MessageLookupByLibrary.simpleMessage("Naklejka"),
