...
const frenchConstants = {
    ...
    DATA_DISCLAIMER:
        'Nous ne partagerons jamais vos données avec qui que ce soit.',
    SUBMIT: 'Soumettre',
    ...
    CHECK_INBOX:
        'Veuillez consulter votre boite de réception (et indésirables) pour poursuivre la vérification',
    ...
    INITIAL_LOAD_DELAY_WARNING:
        'La première consultation peut prendre du temps',
    USER_DOES_NOT_EXIST:
        'Désolé, impossible de trouver un utilisateur avec cet e-mail',
    ...
    SYNC_FAILED:
        'Échec de synchronisation avec le serveur, veuillez rafraîchir la page',
    ...
    LEAVE_FAMILY_CONFIRM:
        'Êtes-vous certains de vouloir quitter le plan famille?',
    ...
    UPDATE_SUBSCRIPTION_MESSAGE:
        'Êtes-vous certains de vouloir changer de plan?',
    ...
    CANCEL_SUBSCRIPTION_MESSAGE: () => (
        <>
            <p>
                Toutes vos données seront supprimées de nos serveurs à la fin de
                cette période d'abonnement.
            </p>
    ...
    SUBSCRIPTION_ACTIVATE_FAILED:
        "Échec lors de la réactivation de l'abonnement",
    ...
    DELETE_COLLECTION_FAILED:
        "L'album n'a pas pu être supprimé, veuillez réessayer",
    DELETE_COLLECTION_MESSAGE: () => (
        <p>
            Supprimer aussi les photos (et vidéos) présentes dans cet album
            depuis
            <span style={{ color: '#fff' }}> tous </span> les autres albums dont
            ils font partie?
        </p>
    ),
    ...
    ALREADY_SHARED: (email) => `Oups, vous partager déjà cela avec ${email}`,
    SHARING_BAD_REQUEST_ERROR: "Partage d'album non autorisé",
    SHARING_DISABLED_FOR_FREE_ACCOUNTS:
        'Le partage est désactivé pour les comptes gratuits',
    ...
    DOWNLOAD_COLLECTION_MESSAGE: () => (
        <>
            ...
            <p>
                Tous les fichiers seront mis en file d'attente pour un
                téléchargement fractionné
            </p>
        </>
    ),
    DOWNLOAD_COLLECTION_FAILED:
        "Échec de téléchargement de l'album, veuillez réessayer",
    ...
    CONFIRM_PASSWORD_NOT_SAVED: () => (
        <p>
            Je comprend que si je perd le mot de passe,je peux perdre mes
            données puisque mes données sont{' '}
            <a
    ...
    NOT_FILE_OWNER:
        "Vous ne pouvez pas supprimer les fichiers d'un album partagé",
    ...
    TWO_FACTOR_SETUP_FAILED:
        'Échec de configuration de la double-authentification, veuillez réessayer',
    TWO_FACTOR_SETUP_SUCCESS: 'La double-authentification est configurée',
    TWO_FACTOR_DISABLE_SUCCESS: 'La double-authentification est désactivée',
    TWO_FACTOR_DISABLE_FAILED:
        'Échec de désactivation de la double-authentification, veuillez réessayer',
    ...
    ETAGS_BLOCKED: (link: string) => (
        <>
            <Box mb={1}>
                Nosu n'avons pas pu charger les fichiers suivants à cause de la
                configuration de votre navigateur .
            </Box>
            <Box>
                Veuillez désactiver tous les compléments qui pourraient empêcher
                ente d'utiliser les<code>eTags</code> pour charger de larges
                fichiers, ou bien utilisez notre{' '}
    ...
    SKIPPED_VIDEOS_INFO: (link: string) => (
        <>
            <Box mb={1}>
                Actuellement, nous ne supportons pas l'ajout de videos via des
                liens publics.{' '}
            </Box>
            <Box>
    ...
    CONFIRM_SELF_REMOVE_MESSAGE: () => (
        <>
            <p>
                Choisir les objets qui seront retirés de cet album. Ceux qui
                sont présents uniquement dans cet album seront déplacés comme
                hors catégorie.
            </p>
        </>
    ),
    CONFIRM_SELF_AND_OTHER_REMOVE_MESSAGE: () => (
        <>
            <p>
                Certains des objets que vous êtes en train de retirer ont été
                ajoutés par d'autres personnes, vous perdrez l'accès vers ces
                objets.
            </p>
        </>
    ),
    ...
    REPLACE_THUMBNAIL_NOT_STARTED: () => (
        <>
            Certaines miniatures de vidéos peuvent être compressées pour gagner
            de la place. Voulez-vous que ente les compresse?
        </>
    ),
    ...
    UPDATE_CREATION_TIME_COMPLETED: () => (
        <>Mise à jour effectuée pour tous les fichiers</>
    ),

    UPDATE_CREATION_TIME_COMPLETED_WITH_ERROR: () => (
        <>
            L'heure du fichier n'a pas été mise à jour pour certains fichiers,
            veuillez réessayer
        </>
    ),
    ...
    REPORT_SUBMIT_FAILED:
        "Échec lors de l'envoi du commentaire, veuillez réessayer",
    INSTALL: 'Installer',
    ...
    LINK_TOO_MANY_REQUESTS:
        'Cet album est trop populaire pour que nous puissions le gérer!',
    ...
    DISABLE_FILE_DOWNLOAD_MESSAGE: () => (
        <>
            <p>
                Êtes-vous certains de vouloir désactiver le bouton de
                téléchargement pour les fichiers ?{' '}
            </p>{' '}
            <p>
                Ceux qui les visualisent pourront tout de même prendre des
                imprim-écrans ou sauvegarder une copie de vos photos en
    ...
    JUDICIAL_DESCRIPTION: () => (
        <>
            ...
            <strong>SOUS PEINE DE FAUX TEMOIGNAGE </strong>aux yeux de la loi
            que:
        </>
    ),
    ...
    DEDUPLICATION_LOGIC_MESSAGE: (captureTime: boolean) => (
        <>
            ...
            {captureTime && ' and capture time'}, veuillez corriger et supprimer
            les objets que vous pensez être dupliqués{' '}
        </>
    ),
    ...
    ENTER_TWO_FACTOR_OTP:
        "Saisir le code à 6 caractères de votre appli d'authentification.",
    ...
    CANVAS_BLOCKED_MESSAGE: () => (
        <>
            <p>
                Il semblerait que votre navigateur ait désactivé l'accès au
                canevas, qui est nécessaire pour créer les miniatures de vos
                photos
            </p>
            <p>
                Veuillez activer l'accès au canevas du navigateur, ou consulter
                notre appli pour ordinateur
            </p>
        </>
    ),
    ...
    DOWNLOAD_LOGS_MESSAGE: () => (
        <>
            <p>
                Cela va télécharger les journaux de débug, que vous pourrez nosu
                envoyer par e-mail pour nous aider à résoudre votre problàme .
            </p>
            <p>Veuillez noter que les noms de fichiers seront inclus .</p>
        </>
    ),
    ...
    ASK_FOR_FEEDBACK: (
        <>
            <p>
                Nous serrions navré de vous voir partir. Avez-vous rencontré des
                problèmes?
            </p>
            <p>
    ...
    CONFIRM_ACCOUNT_DELETION_MESSAGE: (
        <>
            <p>
                Vos données chargées seront programmées pour suppression, et
                votre comptre sera supprimé définitivement .
            </p>
    ...
    ROOT_LEVEL_FILE_WITH_FOLDER_NOT_ALLOWED_MESSAGE: () => (
        <>
            ...
            <p>
                Veuillez sélectionner soit uniquement des fichiers, ou des
                dossiers lors du choix d'options pour créer des albums séparés
            </p>
        </>
    ),
