...
var blazeface = require("./index");
var test_util_1 = require("./test_util");
jasmine_util_1.describeWithFlags('BlazeFace', jasmine_util_1.NODE_ENVS, function () {
    var model;
    beforeAll(function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, blazeface.load()];
                case 1:
                    model = _a.sent();
                    return [2 /*return*/];
            }
