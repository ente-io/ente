...
description: Frequently asked questions about organizing items in Ente Locker
---
...
### How do I organize my items? {#locker-organize-documents}

Use collections to group related items together:

1. When creating an item, tap the collection field
2. Select an existing collection or create a new one
3. Items in the same collection appear together
...
When deleting a collection, you choose what happens to the items:

- **Keep items**: Items are removed from the collection but remain in Locker
- **Delete items**: Items are moved to Trash

The collection itself is permanently deleted.
...
### How do I rename a collection? {#locker-rename-collection}
...
3. Tap on it and select **Restore**
4. The item returns to its original collection

### How do I permanently delete items immediately? {#locker-permanent-delete}
...
- Recently added items may take a moment to become searchable
- Items in Trash are not included in search results

## Related Features

- [Collections](/locker/features/organization/collections)
- [Trash](/locker/features/organization/trash)
- [Search](/locker/features/organization/search)
