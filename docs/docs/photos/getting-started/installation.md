...
- [GitHub](https://github.com/ente/ente/releases?q=photos-v1)
...
If you install the APK directly from GitHub, see [Verify the Ente Photos Android APK](/photos/getting-started/android-apk-signature).
...
> [!NOTE]
>
> The older `web.ente.io` and `photos.ente.io` addresses now redirect to `photos.ente.com`. Your same Ente account and password continue to work there. If your password manager suggests a login saved for the older address, you can use it on `photos.ente.com`.
