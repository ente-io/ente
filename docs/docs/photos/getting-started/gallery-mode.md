...
Ente Photos can be used as a gallery app on your phone without creating an account. This is called **gallery mode**. It gives you a private, on-device photo gallery with smart features like face recognition and natural language search, all without uploading anything to the cloud.

> **Availability**: Gallery mode is available on the **Ente Photos mobile app** (iOS and Android).
...
## Signing up from gallery mode {#signing-up}
...
If you entered gallery mode from the welcome screen and haven't signed up, pressing the back button on the home screen returns you to the welcome screen where you can create an account or sign in.
