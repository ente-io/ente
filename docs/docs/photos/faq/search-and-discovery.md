...
- ❌ ML does NOT work on web.ente.com (web browser)
...
- Make sure you're using the desktop or mobile app, NOT web.ente.com
...
1. Make sure you're using the mobile or desktop app (not web.ente.com)
...
- Ensure you're using mobile or desktop app (not web.ente.com)
- Check that machine learning is enabled in ML settings
- Verify indexing has completed
- Restart the app

Note: Machine learning features only work on mobile and desktop apps, not on web.ente.com.
