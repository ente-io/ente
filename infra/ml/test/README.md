...
Outputs go to `infra/ml/test/out/parity/` by default, including `comparison_report.json`.
...
3. Review `infra/ml/test/out/parity/comparison_report.json` and per-platform `results.json` files.
