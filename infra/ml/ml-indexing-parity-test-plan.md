...
1. Corpus is maintained in `https://github.com/laurenspriem/test-fixtures/tree/ml_more_test_data/ml/indexing/v1`; `run_suite.sh` downloads fixture files to `infra/ml/test_data/ml-indexing/v1` using each manifest item's `source_url`.
