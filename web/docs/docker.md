...
Automated Docker images for the self-hosting web apps are created every Wednesday. You can fetch them from `ghcr.io/ente-io/web`.

These images expose 10 web apps on the following ports:
