    ...
    return (
        <Stack sx={{ gap: 2, mb: 1 }}>
            ...
            <Typography sx={{ color: "text.muted" }}>
                {ut(
                    "Add files directly to shared albums. Add shared files to your albums or shared albums. Favorite files in shared albums. Indicator for shared files in map view.",
                )}
            </Typography>
        </Stack>
    );
