    ...
    return (
        <Stack sx={{ gap: 2, mb: 1 }}>
            ...
            <Typography sx={{ color: "text.muted" }}>
                {ut(
                    "Upload files directly to shared albums. Add shared files to owned albums or shared albums. Favorite files in shared albums. Added indicator for shared files in map view.",
                )}
            </Typography>
        </Stack>
    );
